...
exports.SpeechRecognitionConfig = exports.CustomSpeechRecognizer = exports.SpeechToText = void 0;
const React = __importStar(require("react"));
const react_1 = require("react");
const speech_to_text_1 = __importDefault(require("devextreme/ui/speech_to_text"));
const component_1 = require("./core/component");
const nested_option_1 = __importDefault(require("./core/nested-option"));
const SpeechToText = (0, react_1.memo)((0, react_1.forwardRef)((props, ref) => {
    ...
    const independentEvents = (0, react_1.useMemo)(() => (["onContentReady", "onDisposing", "onEnd", "onError", "onInitialized", "onResult", "onStartClick", "onStopClick"]), []);
    ...
    return (React.createElement((component_1.Component), {
        WidgetClass: speech_to_text_1.default,
        ref: baseRef,
        independentEvents,
        expectedChildren,
        ...props,
...
exports.CustomSpeechRecognizer = CustomSpeechRecognizer;
