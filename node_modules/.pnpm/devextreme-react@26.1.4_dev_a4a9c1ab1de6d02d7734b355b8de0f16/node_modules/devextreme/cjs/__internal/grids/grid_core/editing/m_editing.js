...
class EditingControllerImpl extends _m_modules.default.ViewController {
    ...
    _resetEditColumnName() {
        this._setEditColumnName(void 0, true)
    }
    _getEditColumn() {
        const editColumnName = this.option(_const.EDITING_EDITCOLUMNNAME_OPTION_NAME);
    ...
    _resetEditRowKey() {
        this._refocusEditCell = false;
        this._setEditRowKey(void 0, true)
    }
    _resetEditIndices() {
        this._resetEditColumnName();
        this._resetEditRowKey()
    ...
    prepareButtonItem(headerPanel, name, methodName, sortIndex) {
        ...
        return {
            ...
            options: {
                onInitialized: e => {
                    (0, _renderer.default)(e.element).addClass(headerPanel.getToolbarButtonClass(`${_const.EDIT_BUTTON_CLASS} ${this.addWidgetPrefix(className)}-button`))
                },
    ...
    _allowEditAction(actionName, options) {
        var _this$option;
        const allowEditAction = null === (_this$option = this.option("editing")) || void 0 === _this$option ? void 0 : _this$option[actionName];
    ...
    allowUpdating(options, eventName) {
        var _options$row2;
        let allowEditingForNewRows = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : true;
        if (allowEditingForNewRows && null !== (_options$row2 = options.row) && void 0 !== _options$row2 && _options$row2.isNewRow) {
            return true
        }
        const startEditAction = this.option("editing.startEditAction") ?? _const.DEFAULT_START_EDIT_ACTION;
        const isStartEditEvent = !(0, _type.isDefined)(eventName) || eventName === startEditAction || "down" === eventName;
    ...
    _handleDataSourceChange(args) {
        ...
        if (Array.isArray(dataSource) && changes.length) {
            ...
            if (!isEditNewItem && dataSourceKeys.every(key => !(0, _common.equalByValue)(editRowKey, key))) {
                this.option("editing.editRowKey", void 0)
            }
        }
        return result
    }
