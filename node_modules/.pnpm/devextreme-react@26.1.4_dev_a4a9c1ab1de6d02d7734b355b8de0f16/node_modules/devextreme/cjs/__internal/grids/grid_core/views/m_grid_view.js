...
const VIEW_NAMES = ["columnsSeparatorView", "blockSeparatorView", "trackerView", "headerPanel", "columnHeadersView", "rowsView", "footerView", "columnChooserView", "filterPanelView", "pagerView", "draggingHeaderView", "contextMenuView", "errorView", "headerFilterView", "filterBuilderView", "toastView", "aiPromptEditorView", "aiAssistantView"];
...
class ResizingController extends _m_modules.default.ViewController {
    ...
    _refreshSizes(e) {
        ...
        if ("update" === changeType) {
            var _e$changeTypes;
            if (!(null !== (_e$changeTypes = e.changeTypes) && void 0 !== _e$changeTypes && _e$changeTypes.length)) {
                return (new _deferred.Deferred).resolve(null)
            }
            const items = this._dataController.items();
            const isHidingNoDataPanel = items.length <= 1 && "insert" === e.changeTypes[0];
            const isShowingNoDataPanel = 0 === items.length && "remove" === e.changeTypes[0];
