...
const CONTEXT_MENU_EVENT_NAME = (0, _utils.addNamespace)("dxcontextmenu", _view_item.EVENTS_NAMESPACE.namespace);
class BaseAppointmentView extends _view_item.ViewItem {
    ...
    _dispose() {
        ...
        _events_engine.default.off(this.$element(), CONTEXT_MENU_EVENT_NAME)
    }
    applyElementClasses() {
    ...
    attachContextMenuEvent() {
        _events_engine.default.off(this.$element(), CONTEXT_MENU_EVENT_NAME);
        _events_engine.default.on(this.$element(), CONTEXT_MENU_EVENT_NAME, event => this.option().onContextMenu(this, event))
    }
    onFocusIn() {
