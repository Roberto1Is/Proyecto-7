/**
 * DevExtreme (cjs/__internal/scheduler/header/header.js)
 * Version: 26.1.4
...
class SchedulerHeader extends _widget.default {
    ...
    getIntervalOptions(date) {
        ...
        const step = (0, _utils.getStep)(currentView.type);
        return {
            date: date,
            step: step,
            firstDayOfWeek: firstDayOfWeek,
        ...
        if (itemName) {
            switch (itemName) {
                case ITEM_NAMES.today:
                    return (0, _date_navigator.getTodayButtonOptions)(this, itemOptions);
                case ITEM_NAMES.viewSwitcher:
                    return this.option().useDropDownViewSwitcher ? (0, _view_switcher.getDropDownViewSwitcher)(this, itemOptions) : (0, _view_switcher.getTabViewSwitcher)(this, itemOptions);
                case ITEM_NAMES.dateNavigator:
                    this.renderCalendar();
                    return (0, _date_navigator.getDateNavigator)(this, itemOptions);
                default:
    ...
    renderCalendar() {
        ...
        this.calendar = this._createComponent("<div>", _calendar.default, {
            value: currentDate,
            min: min,
            max: max,
            firstDayOfWeek: firstDayOfWeek,
    ...
    getDisplayedDate() {
        ...
        return isMonth ? (0, _utils.nextWeek)(startViewDate) : startViewDate
    }
    getCaptionOptions() {
        const {
            currentDate: currentDate,
    ...
    getCaption() {
        ...
        return (0, _utils.getCaption)(options, Boolean(useShortDateFormat), customizeDateNavigatorText)
    }
    getHeight() {
        return parseInt((0, _size.getOuterHeight)(this.$element()), 10)
    }
