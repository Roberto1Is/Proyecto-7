...
class Splitter extends _collection_widget.default {
    ...
    _setPanesCacheSize() {
        ...
        items.forEach((item, index) => {
            ...
            if (!(0, _type.isDefined)(null === restriction || void 0 === restriction ? void 0 : restriction.size)) {
                return
            }
    ...
    _getResizeHandleConfig(paneId) {
        ...
        return {
            ...
            onResizeStart: e => {
                ...
                this._currentOnePxRatio = (0, _layout.convertSizeToRatio)(1, (0, _layout.getElementSize)((0, _renderer.default)(this.element()), currentOrientation), this._getResizeHandlesSize());
    ...
    _recalculateLayout(delta, paneIndex) {
        ...
        let newLayout = (0, _layout.getNextLayout)(currentLayout, delta, paneIndex, this._itemRestrictions);
    ...
    _getEligiblePaneIndices(pixels, remaining) {
        ...
        for (let index = 0; index < pixels.length; index += 1) {
            const item = items[index];
            if (!item || false === item.visible || true === item.collapsed || false === item.resizable && (0, _type.isDefined)(this._initialPaneSizes[index])) {
                continue
            }
            const minPx = (0, _layout.tryConvertToNumber)(item.minSize, elementSize) ?? 0;
            const maxPx = (0, _layout.tryConvertToNumber)(item.maxSize, elementSize);
            const clampedPx = this._getClampedPixelSize(pixels[index] + direction, minPx, maxPx);
            if (0 !== (0, _number_comparison.compareNumbersWithPrecision)(clampedPx, pixels[index])) {
                indices.push(index)
            }
        }
        return indices
    ...
    _distributeRemainingPixels(pixels, initialRemaining) {
        ...
        while (0 !== (0, _number_comparison.compareNumbersWithPrecision)(remaining, 0)) {
    ...
    _applyPixelShare(pixels, eligiblePaneIndices, share) {
        ...
        eligiblePaneIndices.forEach(index => {
            ...
            const minPx = (0, _layout.tryConvertToNumber)(null === item || void 0 === item ? void 0 : item.minSize, elementSize) ?? 0;
            const maxPx = (0, _layout.tryConvertToNumber)(null === item || void 0 === item ? void 0 : item.maxSize, elementSize);
            const clampedPx = this._getClampedPixelSize(next, minPx, maxPx);
            const delta = clampedPx - prev;
            if (0 !== (0, _number_comparison.compareNumbersWithPrecision)(delta, 0)) {
