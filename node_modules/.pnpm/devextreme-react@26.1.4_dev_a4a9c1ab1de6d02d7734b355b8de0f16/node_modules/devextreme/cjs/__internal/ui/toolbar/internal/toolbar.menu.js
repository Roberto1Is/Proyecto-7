...
class DropDownMenu extends _widget.default {
    ...
    _dimensionChanged() {
        var _this$_popup6;
        null === (_this$_popup6 = this._popup) || void 0 === _this$_popup6 || _this$_popup6.option("maxHeight", this._getMaxHeight())
    }
        ...
        this._list = this._createComponent($content, _toolbarMenu.default, {
            ...
            _onItemsRendered: () => {
                if (this.option("templatesRenderAsynchronously")) {
                    var _this$_popup7;
                    null === (_this$_popup7 = this._popup) || void 0 === _this$_popup7 || _this$_popup7._renderGeometry()
                }
            }
        })
    }
    ...
    _optionChanged(args) {
        ...
        switch (name) {
            ...
            case "closeOnClick":
                break;
            case "container":
                null === (_this$_popup8 = this._popup) || void 0 === _this$_popup8 || _this$_popup8.option(name, value);
                break;
            case "disabled":
                if (this._list) {
                    this._updateFocusableItemsTabIndex()
