...
export type ODataContextOptions = {
     ...
     * @deprecated Use the processDatesAsUtc option instead.
     */
...
> = AbstractStoreOptions<TItem, TKey> & {
    ...
    errorHandler?: ((e: { httpStatus: number; errorDetails: any; requestOptions: ODataRequestOptions }) => void);
    /**
     * Specifies the data field types. Accepts the following types: &apos;String&apos;, &apos;Int32&apos;, &apos;Int64&apos;, &apos;Boolean&apos;, &apos;Single&apos;, &apos;Decimal&apos;, &apos;Guid&apos;, &apos;Date&apos;, and &apos;DateTimeOffset&apos;.
     */
    fieldTypes?: {
