...
export class AppointmentDataSource {
    ...
    get keyName() {
        ...
        return null === store || void 0 === store ? void 0 : store.key()
    }
    ...
    getStoreKey(target) {
        ...
        const store = null === (_this$dataSource2 = this.dataSource) || void 0 === _this$dataSource2 ? void 0 : _this$dataSource2.store();
        return null === store || void 0 === store ? void 0 : store.keyOf(target)
    }
    ...
    destroy() {
        ...
        const store = null === (_this$dataSource3 = this.dataSource) || void 0 === _this$dataSource3 ? void 0 : _this$dataSource3.store();
        if (store) {
