...
class TagBox extends SelectBox {
    ...
    _setListDataSourceFilter() {
        ...
        if (isString(valueGetterExpr) && "this" !== valueGetterExpr) {
            ...
            if (void 0 === this._userFilter) {
                this._userFilter = dataController.filter(void 0) || null
            }
            if (this._userFilter) {
    ...
    _dataSourceChangedHandler() {
        ...
        super._dataSourceChangedHandler(...arguments)
    }
    _applyButtonHandler(args) {
        this._saveValueChangeEvent(null === args || void 0 === args ? void 0 : args.event);
    ...
    _getListValues() {
        ...
        return this._getPlainItems(selectedItems).map(item => this._valueGetter(item))
    }
    _setListDataSource() {
    ...
    _renderOpenedState() {
        ...
        if ("useButtons" === applyValueMode && !opened) {
            this._refreshSelected()
        }
    }
    clear() {
        ...
        if (0 === (null === defaultValue || void 0 === defaultValue ? void 0 : defaultValue.length) && defaultValue.length === (null === currentValue || void 0 === currentValue ? void 0 : currentValue.length)) {
            return
        }
        super.clear()
    }
    _clean() {
        ...
        this._tagTemplate = void 0;
        this._tagsToRender = void 0;
        this._$tagsContainer = void 0
    }
