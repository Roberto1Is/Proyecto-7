...
class RowsView extends _m_columns_view.ColumnsView {
    ...
    _handleScroll(e) {
        ...
        if (rtlEnabled) {
            ...
            const maxHorizontalScrollOffset = (0, _utils.getMaxHorizontalScrollOffset)(null === (_this$_scrollableCont = this._scrollableContainer) || void 0 === _this$_scrollableCont ? void 0 : _this$_scrollableCont.get(0));
    ...
    _updateHorizontalScrollPosition() {
        ...
        if (rtlEnabled) {
            ...
            const maxHorizontalScrollOffset = (0, _utils.getMaxHorizontalScrollOffset)(null === (_this$_scrollableCont2 = this._scrollableContainer) || void 0 === _this$_scrollableCont2 ? void 0 : _this$_scrollableCont2.get(0));
