...
class EditingController extends _m_editing.editingModule.controllers.editing {
    ...
    _getLoadedRowIndex(items, change, isProcessedItems) {
        ...
        const dataSourceAdapter = this._dataController.dataSource();
        const insertParentKey = null === (_this$_getInternalDat = this._getInternalData(change.key)) || void 0 === _this$_getInternalDat || null === (_this$_getInternalDat = _this$_getInternalDat.insertInfo) || void 0 === _this$_getInternalDat ? void 0 : _this$_getInternalDat.parentKey;
        const parentKey = void 0 !== insertParentKey ? insertParentKey : null === dataSourceAdapter || void 0 === dataSourceAdapter ? void 0 : dataSourceAdapter.parentKeyOf(change.data);
