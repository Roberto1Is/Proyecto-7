/**
 * DevExtreme (cjs/__internal/scheduler/appointment_popup/recurrence_form.js)
 * Version: 26.1.4
...
class RecurrenceForm {
    ...
    createRecurrenceStartDateGroup() {
        return {
            ...
            }, (0, _extend.extend)(true, (0, _utils.getStartDateCommonConfig)(this.config.firstDayOfWeek), {
    ...
    createDaysOfWeekGroup() {
        return {
            ...
            template: () => {
                ...
                const weekDayItems = (0, _localized_items.getRecurrenceWeekDayItems)(this.config.firstDayOfWeek);
                weekDayItems.forEach(item => {
                    ...
                    this.weekDayButtons[item.key] = this.config.createComponent(buttonContainer, _button.default, {
                        text: item.text,
    ...
    createRecurrenceRule(recurrenceRuleRaw, startDate) {
        ...
        if (0 === recurrenceRule.byDay.length) {
            const defaultByDay = [_localized_items.ICAL_WEEK_DAYS[(null === startDate || void 0 === startDate ? void 0 : startDate.getDay()) ?? this.config.firstDayOfWeek ?? 0]];
