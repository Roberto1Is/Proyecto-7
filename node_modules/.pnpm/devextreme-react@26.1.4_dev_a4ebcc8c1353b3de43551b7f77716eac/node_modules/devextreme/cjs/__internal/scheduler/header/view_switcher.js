/**
 * DevExtreme (cjs/__internal/scheduler/header/view_switcher.js)
 * Version: 26.1.4
...
const getViewsAndSelectedView = header => {
    ...
    const formattedViews = (0, _utils.formatViews)(views);
    const selectedView = (0, _utils.getViewName)(currentView);
