...
var _normalize_hidden_days = require("./utils/options/normalize_hidden_days");
...
class SchedulerOptionsBaseWidget extends _ui.default {
    ...
    getTimeZone() {
        return (this.option("timeZone") || _utils_time_zone.default.getMachineTimezoneName()) ?? "Etc/UTC"
    }
    getViewOption(optionName) {
        ...
        if ("hiddenWeekDays" === optionName) {
            if (!this.currentView) {
                return optionValue
            }
            return (0, _normalize_hidden_days.resolveSkippedDays)(this.currentView.hiddenWeekDays, this.option("hiddenWeekDays"), _constants_view.DEFAULT_VIEW_OPTIONS[this.currentView.type].skippedDays)
        }
