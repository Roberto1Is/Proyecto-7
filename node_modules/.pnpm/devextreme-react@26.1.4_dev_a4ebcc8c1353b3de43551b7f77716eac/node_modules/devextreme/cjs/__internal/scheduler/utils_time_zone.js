/**
 * DevExtreme (cjs/__internal/scheduler/utils_time_zone.js)
 * Version: 26.1.4
...
const getTimezoneOffsetChangeInMs = (startDate, endDate, updatedStartDate, updatedEndDate) => {
    const minutes = getTimezoneOffsetChangeInMinutes(startDate, endDate, updatedStartDate, updatedEndDate);
...
const isSameAppointmentDates = (startDate, endDate) => {
    ...
    return _date2.default.sameDate(startDate, adjustedEndDate)
};
