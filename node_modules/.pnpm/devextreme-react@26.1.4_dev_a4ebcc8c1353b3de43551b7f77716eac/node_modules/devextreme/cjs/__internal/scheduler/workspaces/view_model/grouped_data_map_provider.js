/**
 * DevExtreme (cjs/__internal/scheduler/workspaces/view_model/grouped_data_map_provider.js)
 * Version: 26.1.4
...
class GroupedDataMapProvider {
    ...
    findGroupCellStartDate(groupIndex, startDate, endDate, isFindByDate) {
        ...
        if (void 0 === startDateVerticalSearch) {
            return startDateHorizontalSearch
        }
        if (void 0 === startDateHorizontalSearch) {
            return startDateVerticalSearch
        }
    ...
    findCellPositionInMap(cellInfo, isAppointmentRender) {
        ...
        let rows = dateTableGroupedMap[normalizedGroupIndex] || [];
    ...
    getCellSecondIntervalOffset(cellStartDate, cellEndDate) {
        ...
        const cellTimezoneDiff = _utils_time_zone.default.getDaylightOffset(cellStartDate, cellEndDate);
        const cellNextHourTimezoneDiff = _utils_time_zone.default.getDaylightOffset(cellStartDate, nextHourCellStartDate);
    ...
    getCompletedGroupsInfo() {
        ...
        }).filter(info => Boolean(info.startDate) && Boolean(info.endDate))
    }
    getGroupIndices() {
    ...
    getLastGroupCellPosition(groupIndex) {
        ...
        const lastCell = null === groupRow || void 0 === groupRow ? void 0 : groupRow[groupRow.length - 1];
        return null === lastCell || void 0 === lastCell ? void 0 : lastCell.position
    }
