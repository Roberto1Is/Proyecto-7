/**
 * DevExtreme (cjs/__internal/ui/color_box/color_view.js)
 * Version: 26.1.4
...
var _m_click = require("../../events/m_click");
...
var _m_number_box2 = require("../../ui/number_box/m_number_box.base");
var _text_box = _interopRequireDefault(require("../../ui/text_box/text_box"));
...
class ColorView extends _editor.default {
    _supportedKeys() {
        ...
        const updatePaletteValue = () => {
            ...
            this._updateColorFromHsv(this._currentColor.hsv.h, this._currentColor.hsv.s, this._currentColor.hsv.v)
        };
        ...
        const updateHueScaleValue = step => {
            ...
            const handleLocation = (0, _translator.locate)(this._$hueScaleHandle);
        ...
        const updateAlphaScaleValue = step => {
            ...
            const handleLocation = (0, _translator.locate)(this._$alphaChannelHandle);
            this._calculateColorTransparencyByScaleWidth(handleLocation.left + this._alphaChannelHandleWidth / 2)
        };
    ...
    _defaultOptionsRules() {
        return super._defaultOptionsRules().concat([{
            device: () => "desktop" === _m_devices.default.real().deviceType && !_m_devices.default.isSimulator(),
            options: {
    ...
    _setCurrentColor(currentValue) {
        ...
        if (!newColor.colorIsInvalid) {
            ...
            if (!this._currentColor) {
                this._currentColor = new _color.Color("#000000")
            }
            this.option("value", this._currentColor.baseColor)
        }
    }
    _setBaseColor(baseValue) {
        const color = baseValue ?? "#000000";
        const newColor = new _color.Color(color);
        if (!newColor.colorIsInvalid) {
            const {
    ...
    _renderPalette() {
        ...
        this._paletteHeight = (0, _m_size.getHeight)(this._$palette);
        this._paletteWidth = (0, _m_size.getWidth)(this._$palette);
    ...
    _renderPaletteHandle() {
        ...
        const ariaId = `dx-${new _m_guid.Guid}`;
        const handleAria = {
            id: ariaId,
            role: "application"
        };
        ...
        this._createComponent(this._$paletteHandle, _m_draggable.default, {
        ...
        this._paletteHandleWidth = (0, _m_size.getWidth)(this._$paletteHandle);
        this._paletteHandleHeight = (0, _m_size.getHeight)(this._$paletteHandle);
        this._placePaletteHandle()
    }
    _placePaletteHandle() {
    ...
    _updateColorFromHsv(hue, saturation, value) {
        ...
        this._currentColor = new _color.Color(`hsv(${[hue,saturation,value].join(",")})`);
    ...
    _renderHueScale() {
        ...
        this._hueScaleHeight = (0, _m_size.getHeight)(this._$hueScale);
        this._hueScaleWrapperHeight = (0, _m_size.getOuterHeight)(this._$hueScaleWrapper);
        this._renderHueScaleHandle()
    }
    _renderHueScaleHandle() {
        if (void 0 !== this._$hueScaleWrapper) {
            this._$hueScaleHandle = (0, _renderer.default)("<div>").addClass("dx-colorview-hue-scale-handle").appendTo(this._$hueScaleWrapper);
            this._createComponent(this._$hueScaleHandle, _m_draggable.default, {
                contentTemplate: null,
        ...
        this._hueScaleHandleHeight = (0, _m_size.getHeight)(this._$hueScaleHandle);
        this._placeHueScaleHandle()
    }
    ...
    _renderColorsPreview() {
        ...
        this._makeTransparentBackground(this._$baseColor, new _color.Color(matchValue ?? "#000000"));
    ...
    _renderRgbInputs() {
        ...
        this._rgbInputs = [_m_number_box.default.getInstance(this._rgbInputsWithLabels[0].find(`.${_m_number_box2.WIDGET_CLASS}`)), _m_number_box.default.getInstance(this._rgbInputsWithLabels[1].find(`.${_m_number_box2.WIDGET_CLASS}`)), _m_number_box.default.getInstance(this._rgbInputsWithLabels[2].find(`.${_m_number_box2.WIDGET_CLASS}`))]
    }
    _renderEditorWithLabel(options) {
        ...
        _m_events_engine.default.off($label, _m_click.name);
        _m_events_engine.default.on($label, _m_click.name, e => {
            e.preventDefault()
        });
        const {
            editorType: EditorConstructor
        } = options;
        const {
            stylingMode: stylingMode
        } = this.option();
        const editorOptions = (0, _m_extend.extend)({
            value: options.value,
        ...
        if (EditorConstructor === _m_number_box.default) {
    ...
    _renderHexInput() {
        ...
        const inputId = `dx-${new _m_guid.Guid}`;
    ...
    _renderAlphaChannelInput() {
        ...
        const editorWithLabel = this._renderEditorWithLabel({
            ...
            onValueChanged: args => {
                ...
                value = _color.Color.isValidAlpha(value) ? value : this._currentColor.a;
                if (args.event) {
        ...
        this._alphaChannelInput = _m_number_box.default.getInstance(editorWithLabel.find(`.${_m_number_box2.WIDGET_CLASS}`))
    }
    ...
    _renderAlphaChannelHandle($parent) {
        ...
        this._createComponent(this._$alphaChannelHandle, _m_draggable.default, {
            contentTemplate: null,
            boundary: $parent,
            allowMoveByClick: true,
        ...
        this._alphaChannelHandleWidth = (0, _m_size.getWidth)(this._$alphaChannelHandle);
        this._alphaChannelScaleWorkWidth = (0, _m_size.getWidth)($parent) - this._alphaChannelHandleWidth;
        this._placeAlphaChannelHandle()
    }
    ...
    applyColor() {
        ...
        const colorValue = editAlphaChannel ? this._makeRgba(this._currentColor) : this._currentColor.toHex();
        if (this._$currentColor) {
            this._makeTransparentBackground(this._$currentColor, this._currentColor)
        }
    ...
    _updateColor(isHex, args) {
        ...
        if (isHex) {
            ...
            if (this._alphaChannelInput) {
                const {
                    value: alphaValue
                } = this._alphaChannelInput.option();
                const isValidAlpha = void 0 !== alphaValue && _color.Color.isValidAlpha(alphaValue);
        ...
        if (!this._suppressEditorsValueUpdating) {
            this._currentColor = new _color.Color(newColor);
            this._saveValueChangeEvent(args.event);
            this.applyColor();
            this._refreshMarkup()
        }
    ...
    _validateHex(hex) {
        return _color.Color.isValidHex(hex) ? hex : this._currentColor.toHex()
    }
    _validateRgb() {
        let {
            value: r
        } = this._rgbInputs[0].option();
        let {
            value: g
        } = this._rgbInputs[1].option();
        let {
            value: b
        } = this._rgbInputs[2].option();
        const isInvalidRgb = !_color.Color.isValidRGB(r, g, b);
        if (isInvalidRgb) {
