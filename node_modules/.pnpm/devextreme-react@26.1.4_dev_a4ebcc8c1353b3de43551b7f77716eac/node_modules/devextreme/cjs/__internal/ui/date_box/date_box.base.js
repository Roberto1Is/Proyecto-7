...
class DateBox extends _drop_down_editor.default {
    _supportedKeys() {
    ...
    _updatePopupWidth() {
        if (this._strategy instanceof _m_date_boxStrategy.default || this._strategy instanceof _m_date_boxStrategy2.default) {
            return
        }
