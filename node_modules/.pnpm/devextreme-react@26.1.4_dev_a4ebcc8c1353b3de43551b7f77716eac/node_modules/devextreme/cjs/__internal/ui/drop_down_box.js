/**
 * DevExtreme (cjs/__internal/ui/drop_down_box.js)
 * Version: 26.1.4
...
class DropDownBox extends _drop_down_editor.default {
    _supportedKeys() {
    ...
    _shouldUseDisplayValue(value) {
        ...
        return "this" === valueExpr && (0, _type.isObject)(value)
    }
    ...
    _loadItem(value) {
        const deferred = (0, _deferred.Deferred)();
        const selectedItem = (0, _m_common.grep)(this.option("items") || [], item => this._isValueEquals(this._valueGetter(item), value), false)[0];
    ...
    _renderPopupContent() {
        var _this$_popup;
        const {
            contentTemplate: optionContentTemplate
        } = this.option();
        if ("content" === optionContentTemplate) {
            return
        }
    ...
    _isNestedElementActive() {
        ...
        return !!(activeElement && null !== (_this$_popup2 = this._popup) && void 0 !== _this$_popup2 && null !== (_this$_popup2 = _this$_popup2.$content()) && void 0 !== _this$_popup2 && null !== (_this$_popup2 = _this$_popup2.get(0)) && void 0 !== _this$_popup2 && _this$_popup2.contains(activeElement))
    }
