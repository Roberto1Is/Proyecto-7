/**
 * DevExtreme (cjs/__internal/ui/popup/popup.js)
 * Version: 26.1.4
...
var _popup_drag = _interopRequireDefault(require("../../ui/popup/popup_drag"));
var _popup_overflow_manager = require("../../ui/popup/popup_overflow_manager");
var _popup_position_controller = require("../../ui/popup/popup_position_controller");
...
class Popup extends _overlay.default {
    ...
    _keyboardHandler(options, onlyChildProcessing) {
        const {
            _ignoreCloseOnChildEscape: _ignoreCloseOnChildEscape
        } = this.option();
        const e = options.originalEvent;
        const $target = (0, _renderer.default)(e.target);
        if (this._$content && !$target.is(this._$content) && "escape" === options.keyName && !e.isDefaultPrevented() && !_ignoreCloseOnChildEscape) {
            this.hide()
        }
    ...
    _defaultOptionsRules() {
        ...
        return [...defaultOptionsRules, ...popupSpecificDefaultOptionsRules]
    }
    _iosAnimation() {
        return {
            show: {
    ...
    _areContentDimensionsRendered(entry) {
        ...
        if (contentBox) {
            ...
            const isWidthEqualContentBoxInlineSize = parseInt(String(contentBox.inlineSize), 10) === (null === (_this$_renderedDimens = this._renderedDimensions) || void 0 === _this$_renderedDimens ? void 0 : _this$_renderedDimens.width);
            const isHeightEqualContentBoxBlockSize = parseInt(String(contentBox.blockSize), 10) === (null === (_this$_renderedDimens2 = this._renderedDimensions) || void 0 === _this$_renderedDimens2 ? void 0 : _this$_renderedDimens2.height);
            return isWidthEqualContentBoxInlineSize && isHeightEqualContentBoxBlockSize
        }
        const {
            contentRect: contentRect
        } = entry;
        const isWidthEqualContentBoxWidth = parseInt(String(contentRect.width), 10) === (null === (_this$_renderedDimens3 = this._renderedDimensions) || void 0 === _this$_renderedDimens3 ? void 0 : _this$_renderedDimens3.width);
        const isHeightEqualContentBoxHeight = parseInt(String(contentRect.height), 10) === (null === (_this$_renderedDimens4 = this._renderedDimensions) || void 0 === _this$_renderedDimens4 ? void 0 : _this$_renderedDimens4.height);
    ...
    _getToolbarItems(toolbar) {
        ...
        (0, _iterator.each)(toolbarItems, (_, data) => {
            ...
            if ((null === item || void 0 === item ? void 0 : item.toolbar) === toolbar) {
                if (isShortcut) {
    ...
    _getToolbarButtonStylingMode(shortcut) {
        ...
        return useFlatToolbarButtons ? "text" : "contained"
    }
    _getToolbarButtonType(shortcut) {
        const isFluentTheme = (0, _themes.isFluent)((0, _themes.current)());
        const {
            useDefaultToolbarButtons: useDefaultToolbarButtons
        } = this.option();
        if (isFluentTheme && "done" === shortcut || useDefaultToolbarButtons) {
            return "default"
        }
        return "normal"
    }
