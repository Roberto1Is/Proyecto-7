...
const KEYDOWN_EVENT_NAME = (0, _index.addNamespace)("keydown", RESIZABLE);
...
class Resizable extends _dom_component.default {
    ...
    _attachEventHandlers() {
        ...
        _events_engine.default.on(this.$element(), KEYDOWN_EVENT_NAME, this._keydownHandler.bind(this))
    }
    _detachEventHandlers() {
        this._handles.forEach(handleElement => {
            _events_engine.default.off(handleElement)
        });
        _events_engine.default.off(this.$element(), KEYDOWN_EVENT_NAME)
    }
    ...
    _keydownHandler(e) {
        ...
        if (this._isResizing && "Escape" === e.key) {
            this._cancelResize()
        }
    }
    _cancelResize() {
    ...
    _restoreSize() {
        ...
        (0, _translator.move)(this.$element(), this._elementLocation);
        (0, _visibility_change.triggerResizeEvent)(this.$element())
    }
    _renderWidth(width) {
        const {
