...
/**
 * A value compatible with filtering operations.
 */
...
/**
 * Configures the widget AI Assistant.
 */
...
export interface ColumnBase<TRowData = any> {
  ...
  /**
   * Specifies the column&apos;s unique identifier. If not defined, this value is inherited from the column&apos;s dataField property.
   */
...
export interface GridBase<TRowData = any, TKey = any> {
  ...
  /**
   * Returns the scrolling component within the widget.
   */
