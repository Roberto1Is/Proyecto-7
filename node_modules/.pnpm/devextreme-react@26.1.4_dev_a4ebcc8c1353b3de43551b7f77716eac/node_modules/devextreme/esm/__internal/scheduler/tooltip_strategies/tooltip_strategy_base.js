/**
 * DevExtreme (esm/__internal/scheduler/tooltip_strategies/tooltip_strategy_base.js)
 * Version: 26.1.4
...
export class TooltipStrategyBase {
    ...
    showCore(dataList) {
        ...
        const describedByValue = $target && isRenderer($target) ? $target.attr("aria-describedby") : void 0;
        if (!this.tooltip) {
