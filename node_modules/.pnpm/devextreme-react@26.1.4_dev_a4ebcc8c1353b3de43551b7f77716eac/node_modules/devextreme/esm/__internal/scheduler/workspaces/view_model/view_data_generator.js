/**
 * DevExtreme (esm/__internal/scheduler/workspaces/view_model/view_data_generator.js)
 * Version: 26.1.4
...
export class ViewDataGenerator {
    ...
    get daysInInterval() {
        const isWeekLikeView = [VIEWS.WEEK, VIEWS.TIMELINE_WEEK, VIEWS.WORK_WEEK, VIEWS.TIMELINE_WORK_WEEK].includes(this.viewType);
