...
} from "../../ui/drop_down_editor/drop_down_editor";
...
} from "../../ui/text_box/text_editor.base";
import {
    TOOLBAR_CLASS
...
class Form extends Widget {
    ...
    _getContent() {
        ...
        return scrollingEnabled ? $(null === (_this$getScrollable = this.getScrollable()) || void 0 === _this$getScrollable ? void 0 : _this$getScrollable.content()) : this.$element()
    }
    ...
    _applyGroupColCount($group, colCount) {
        ...
        $group.addClass(`${GROUP_COL_COUNT_CLASS}${colCount}`).attr(GROUP_COL_COUNT_ATTR, colCount)
    }
