/**
 * DevExtreme (cjs/__internal/grids/grid_core/ai_assistant/commands/columns.js)
 * Version: 26.1.4
...
exports.columnsVisibilityCommand = exports.columnsResizeCommand = exports.columnsReorderCommand = exports.columnsPinningCommand = void 0;
var _zod = require("zod");
var _defineGridCommand = require("./defineGridCommand");
var _utils = require("./utils");
const columnsVisibilityCommandSchema = _zod.z.object({
    dataField: _zod.z.string(),
    visible: _zod.z.boolean()
}).strict();
const columnsVisibilityCommand = exports.columnsVisibilityCommand = (0, _defineGridCommand.defineGridCommand)({
    ...
    execute: (component, _ref) => {
        ...
        return args => {
            ...
            const caption = (null === column || void 0 === column ? void 0 : column.caption) ?? args.dataField;
            const defaultMessage = args.visible ? `Display the column "${caption}".` : `Hide the column "${caption}".`;
            if (!component.option("columnChooser.enabled")) {
                return Promise.resolve(failure(defaultMessage))
            }
            if (!column || !args.visible && false === column.allowHiding) {
                return Promise.resolve(failure(defaultMessage))
            }
            try {
...
const columnsReorderCommandSchema = _zod.z.object({
    dataField: _zod.z.string(),
    visibleIndex: _zod.z.number().int().nonnegative()
}).strict();
const columnsReorderCommand = exports.columnsReorderCommand = (0, _defineGridCommand.defineGridCommand)({
    name: "columnsReorder",
    ...
    execute: (component, _ref2) => {
        ...
        return args => {
            ...
            const reorderingAllowed = !!component.option("allowColumnReordering") && !!(null !== column && void 0 !== column && column.allowReordering);
...
const columnsPinningCommandSchema = _zod.z.object({
    dataField: _zod.z.string(),
    fixed: _zod.z.boolean(),
    fixedPosition: (0, _utils.optionalNullish)(_zod.z.enum(["left", "right"]))
}).strict();
const columnsPinningCommand = exports.columnsPinningCommand = (0, _defineGridCommand.defineGridCommand)({
    name: "columnsPinning",
    ...
    execute: (component, _ref3) => {
        ...
        return args => {
            ...
            const column = columnsController.columnOption(args.dataField);
            const caption = (null === column || void 0 === column ? void 0 : column.caption) ?? args.dataField;
            const defaultMessage = args.fixed ? `Fix the column "${caption}".` : `Unfix the column "${caption}".`;
            const fixingAllowed = !!component.option("columnFixing.enabled") && !!(null !== column && void 0 !== column && column.allowFixing);
            if (!fixingAllowed) {
                return Promise.resolve(failure(defaultMessage))
            }
            try {
                columnsController.columnOption(column.index, {
                    fixed: args.fixed,
                    fixedPosition: args.fixed ? args.fixedPosition : void 0
                });
                return Promise.resolve(success(defaultMessage))
            } catch {
                return Promise.resolve(failure(defaultMessage))
...
const columnsResizeCommandSchema = _zod.z.object({
    dataField: _zod.z.string(),
    width: _zod.z.union([_zod.z.number(), _zod.z.string()])
}).strict();
const columnsResizeCommand = exports.columnsResizeCommand = (0, _defineGridCommand.defineGridCommand)({
    name: "columnsResize",
    ...
    execute: (component, _ref4) => {
        ...
        return args => {
            ...
            const resizingAllowed = !!component.option("allowColumnResizing") && !!(null !== column && void 0 !== column && column.allowResizing);
            if (!resizingAllowed) {
                return Promise.resolve(failure(defaultMessage))
            }
            try {
