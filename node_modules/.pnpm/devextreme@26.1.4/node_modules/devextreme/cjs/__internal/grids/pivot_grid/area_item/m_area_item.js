...
class AreaItem {
    ...
    _createTableElement() {
        return (0, _renderer.default)("<table>").attr("id", `dx-${new _guid.default}`).attr("role", "presentation")
    }
    ...
    _getColumnIndexOffset() {
        var _this$component$_data;
        return (null === (_this$component$_data = this.component._dataController) || void 0 === _this$component$_data ? void 0 : _this$component$_data.getColumnIndexOffset()) || 0
    }
    _getRowIndexOffset() {
        var _this$component$_data2;
        return (null === (_this$component$_data2 = this.component._dataController) || void 0 === _this$component$_data2 ? void 0 : _this$component$_data2.getRowIndexOffset()) || 0
    }
    _createColumnIndexMap(data) {
        const columnIndexMap = new Map;
        (0, _m_virtual_columns_core.foreachColumnInfo)(data, (cell, visibleIndex, rowIndex, colIndex) => {
    ...
    _setCellAriaIndexAttributes(td, options) {
        ...
        if ("column" === areaName || "data" === areaName) {
            const visibleColumnIndex = "column" === areaName ? columnIndexMap.get(`${rowIndex}-${columnIndex}`) : columnIndex;
            if (void 0 !== visibleColumnIndex) {
                td.setAttribute("aria-colindex", String(visibleColumnIndex + columnIndexOffset + 1))
            }
        }
        if ("row" === areaName || "data" === areaName) {
    ...
    _renderTableContent(tableElement, data) {
        ...
        const columnIndexMap = "column" === areaName ? this._createColumnIndexMap(data) : null;
        ...
        for (let i = 0; i < rowsCount; i += 1) {
            ...
            for (let j = 0; j < row.length; j += 1) {
                ...
                if (cellAriaRole && !(null !== cell && void 0 !== cell && cell.isWhiteSpace)) {
                ...
                if (cell) {
                    ...
                    if ((0, _type.isDefined)(cell.expanded)) {
                        ...
                        const expandSpan = _dom_adapter.default.createElement("span");
                        expandSpan.classList.add("dx-expand");
                ...
                td.appendChild(span);
                if (null !== cell && void 0 !== cell && cell.sorted) {
                    const sortedSpan = _dom_adapter.default.createElement("span");
    ...
    _createFakeTable() {
        const that = this;
        if (!that._fakeTable) {
            that._fakeTable = that.tableElement().clone().removeAttr("id").attr("aria-hidden", "true").addClass(_const.FAKE_TABLE_CLASS);
