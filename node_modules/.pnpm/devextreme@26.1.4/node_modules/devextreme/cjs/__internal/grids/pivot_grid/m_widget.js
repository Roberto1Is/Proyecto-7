...
var _table_cell_navigation = require("./keyboard_navigation/table_cell_navigation");
...
class PivotGrid extends _widget.default {
        ...
        const popupOptions = {
            ...
            onHidden(e) {
                ...
                if (that.$fieldChooserButton) {
                    that.$fieldChooserButton.get(0).focus()
                }
            }
        };
                ...
                if (items) {
                    ...
                    if ("keydown" === event.type) {
                        if (actionArgs.position) {
                            actionArgs.position.of = (0, _renderer.default)(targetElement)
                        }
                    } else {
                        that._contextMenuOwnerNavigation = void 0
                    }
                    actionArgs.cancel = false
                }
            },
            onHidden() {
                var _that$_contextMenuOwn;
                null === (_that$_contextMenuOwn = that._contextMenuOwnerNavigation) || void 0 === _that$_contextMenuOwn || _that$_contextMenuOwn.refocusFocusedItem();
                that._contextMenuOwnerNavigation = void 0
            },
            onItemClick(params) {
    ...
    _getColumnsAreaNavigation() {
        this._columnsAreaNavigation = this._columnsAreaNavigation ?? new _roving_tab_index.RovingTabIndex({
            component: this,
    ...
    _getRowsAreaNavigation() {
        this._rowsAreaNavigation = this._rowsAreaNavigation ?? new _roving_tab_index.RovingTabIndex({
            component: this,
    ...
    _getHeaderAreaCells(cellSelector) {
        const element = this.$element().get(0);
        if (!element) {
            return []
        }
        const cells = Array.from(element.querySelectorAll(cellSelector));
        return cells.filter(cell => !cell.closest(`.${_const.FAKE_TABLE_CLASS}`))
    }
    _getColumnHeaderCells() {
        return this._getHeaderAreaCells(`thead.${_const.HORIZONTAL_HEADERS_AREA_CLASS} td[tabindex]`)
    }
    _getRowHeaderCells() {
        return this._getHeaderAreaCells(`tbody.${_const.VERTICAL_HEADERS_AREA_CLASS} td[tabindex]`)
    }
    _getCellAreaNavigation(cell) {
        var _cell$closest, _cell$closest2, _cell$closest3;
        if (null !== (_cell$closest = cell.closest) && void 0 !== _cell$closest && _cell$closest.call(cell, `.${_const.FAKE_TABLE_CLASS}`)) {
            return
        }
        if (null !== (_cell$closest2 = cell.closest) && void 0 !== _cell$closest2 && _cell$closest2.call(cell, `thead.${_const.HORIZONTAL_HEADERS_AREA_CLASS}`)) {
            return this._getColumnsAreaNavigation()
        }
        if (null !== (_cell$closest3 = cell.closest) && void 0 !== _cell$closest3 && _cell$closest3.call(cell, `tbody.${_const.VERTICAL_HEADERS_AREA_CLASS}`)) {
            return this._getRowsAreaNavigation()
        }
        return
    }
    _normalizeCellNavigationDirection(direction) {
    ...
    _handleCellArrowKeyDown(e, direction) {
        ...
        let target = (0, _table_cell_navigation.getAdjacentCell)(section, cell, normalizedDirection);
        while (target && !target.hasAttribute("tabindex")) {
            target = (0, _table_cell_navigation.getAdjacentCell)(section, target, normalizedDirection)
        }
        if (target) {
    ...
    _handleCellFocusIn(e) {
        var _this$_getCellAreaNav;
        null === (_this$_getCellAreaNav = this._getCellAreaNavigation(e.currentTarget)) || void 0 === _this$_getCellAreaNav || _this$_getCellAreaNav.handleFocusIn(e.currentTarget)
    }
    ...
    _handleCellKeyDown(e) {
        ...
        if ("ContextMenu" === e.key || e.shiftKey && "F10" === e.key) {
        ...
        if (!cell || !(0, _type.isDefined)(cell.expanded)) {
            return
        }
        e.preventDefault();
        ...
        const $control = (0, _renderer.default)(e.currentTarget).find(".dx-expand-icon-container");
        (0, _accessibility.saveFocusedElementInfo)($control.get(0), this);
        const onReady = () => {
    ...
    _renderDescriptionArea() {
        ...
        let $targetContainer;
        let buttonStylingMode = (0, _themes.isGeneric)((0, _themes.current)()) ? "contained" : "text";
        ...
        if (this.option("fieldChooser.enabled")) {
            this.$fieldChooserButton = (0, _renderer.default)(DIV).appendTo($toolbarContainer).addClass("dx-pivotgrid-field-chooser-button");
            const buttonOptions = {
                icon: "columnchooser",
            ...
            this._createComponent(this.$fieldChooserButton, _button.default, buttonOptions)
        }
    ...
    _renderHeaders(rowHeaderContainer, columnHeaderContainer, filterHeaderContainer, dataHeaderContainer) {
        ...
        const fieldChooser = this.$element().dxPivotGridFieldChooserBase("instance");
        fieldChooser.renderSortable();
        fieldChooser.restoreFieldFocus()
    }
    _createTableElement() {
        const $table = (0, _renderer.default)("<table>").attr("role", "presentation").css({
            width: "100%"
        ...
        _events_engine.default.on($table, (0, _index.addNamespace)("keydown", "dxPivotGrid"), "td", this._handleCellKeyDown.bind(this));
        _events_engine.default.on($table, (0, _index.addNamespace)("focusin", "dxPivotGrid"), "td", this._handleCellFocusIn.bind(this));
        return $table
    }
    ...
    _scheduleNavigationFocusRestore(navigation) {
        const onReady = () => {
            this.off("contentReady", onReady);
    ...
    _initMarkup() {
        super._initMarkup();
        this.$element().addClass("dx-pivotgrid").attr("role", "group").attr("aria-label", _message.default.format("dxPivotGrid-ariaLabel"))
    }
    _renderContentImpl() {
        const that = this;
