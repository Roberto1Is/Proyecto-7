...
class DataSourceAdapterTreeList extends _m_data_source_adapter.default {
    ...
    _calculateOperationTypes(loadOptions, lastLoadOptions, isFullReload) {
        ...
        return Object.assign({}, super._calculateOperationTypes(loadOptions, lastLoadOptions, isFullReload), {
            nodeExpanding: !(0, _common.equalByValue)(this._lastExpandedRowKeys, currentExpandedKeys)
        })
    }
    ...
    _loadParentsOrChildren(data, options, needChildren) {
        ...
        const concatLoadedData = loadedData => {
            if (isRemoteFiltering) {
                const updatedData = applySorting(this._cachedStoreData.concat(loadedData), sort);
    ...
    _handleDataLoaded(options) {
        ...
        if (!options.isCustomLoading) {
            var _this$option;
            this._lastExpandedRowKeys = null === (_this$option = this.option("expandedRowKeys")) || void 0 === _this$option ? void 0 : _this$option.slice()
        }
