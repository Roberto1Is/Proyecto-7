...
var _tooltip = require("../../../ui/tooltip/tooltip");
...
class Appointment extends _dom_component.default {
    ...
    _setResourceColor() {
        ...
        resourceManager.getAppointmentColor(appointmentConfig).then(color => {
            if (color) {
                ...
                this.coloredElement.addClass(_classes.APPOINTMENT_HAS_RESOURCE_COLOR_CLASS)
            }
        })
    }
    _renderAriaLabel() {
        ...
        void(0, _text_utils.getAriaDescription)(this.option()).then(text => {
            const $description = $element.find(`.${_classes.APPOINTMENT_CONTENT_CLASSES.ARIA_DESCRIPTION}`);
    ...
    _renderAppointmentReducedIcon() {
        const $icon = (0, _renderer.default)("<div>").addClass(_classes.REDUCED_APPOINTMENT_ICON).appendTo(this.$element());
    ...
    _renderAllDayClass() {
        this.$element().toggleClass(_classes.ALL_DAY_APPOINTMENT_CLASS, Boolean(this.option("allDay")))
    }
    _renderDragSourceClass() {
        this.$element().toggleClass(_classes.APPOINTMENT_DRAG_SOURCE_CLASS, Boolean(this.option("isDragSource")))
    }
