...
const getStartViewDateTimeOffset = (startViewDate, startDayHour) => {
    ...
    const isDSTChange = _utils_time_zone.default.isTimezoneChangeInDate(startViewDate);
...
const getValidCellDateForLocalTimeFormat = (date, _ref) => {
    ...
    const localTimeZoneChangedInOriginDate = _utils_time_zone.default.isTimezoneChangeInDate(originDate);
...
const getStartViewDateWithoutDST = (startViewDate, startDayHour) => {
    const newStartViewDate = _utils_time_zone.default.getDateWithoutTimezoneChange(startViewDate);
