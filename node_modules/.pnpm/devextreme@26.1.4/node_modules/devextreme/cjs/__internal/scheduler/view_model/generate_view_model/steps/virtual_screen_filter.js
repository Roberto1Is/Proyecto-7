...
const filterByVirtualScreen = (entities, viewDataProvider, isVirtualScrolling) => {
    ...
    groupsInfo.forEach(group => {
        groupIntervalsMap.set(group.groupIndex, {
            min: _utils_time_zone.default.createUTCDateWithLocalOffset(group.startDate).getTime(),
            max: _utils_time_zone.default.createUTCDateWithLocalOffset(group.endDate).getTime()
        })
    });
