/**
 * DevExtreme (cjs/__internal/scheduler/workspaces/work_space.js)
 * Version: 26.1.4
...
var _position_helper = require("./helpers/position_helper");
...
var _work_space_grouped_strategy_horizontal = _interopRequireDefault(require("./work_space_grouped_strategy_horizontal"));
var _work_space_grouped_strategy_vertical = _interopRequireDefault(require("./work_space_grouped_strategy_vertical"));
...
const SCHEDULER_TABLE_DXPOINTERUP_EVENT_NAME = (0, _index.addNamespace)(_pointer.default.up, "dxSchedulerTable");
...
const DRAG_AND_DROP_SELECTOR = `.${_classes.DATE_TABLE_CLASS} td, .${ALL_DAY_TABLE_CLASS} td`;
...
class SchedulerWorkSpace extends _widget.default {
    constructor() {
        super(...arguments);
    ...
    get viewDataProvider() {
        this.viewDataProviderValue ?? (this.viewDataProviderValue = new _view_data_provider.default(this.type));
        return this.viewDataProviderValue
    }
    get cache() {
        this.cacheValue ?? (this.cacheValue = new _global_cache.Cache);
    ...
    get cellsSelectionState() {
        ...
        this.cellsSelectionStateValue ?? (this.cellsSelectionStateValue = new _cells_selection_state.default(this.viewDataProvider));
        if (isFirstInit) {
    ...
    get cellsSelectionController() {
        this.cellsSelectionControllerValue ?? (this.cellsSelectionControllerValue = new _cells_selection_controller.CellsSelectionController);
    ...
    _supportedKeys() {
        const enterKeydownHandler = e => {
            ...
            if (null !== selectedCells && void 0 !== selectedCells && selectedCells.length) {
                ...
                null === (_this$cellClickAction = this.cellClickAction) || void 0 === _this$cellClickAction || _this$cellClickAction.call(this, {
                    event: e,
                    cellElement: (0, _element.getPublicElement)((0, _renderer.default)(cellElements)),
        ...
        return (0, _extend.extend)(super._supportedKeys(), supportedKeys)
    }
    isRTL() {
    ...
    createRAllDayPanelElements() {
        this.$allDayPanel = (0, _renderer.default)("<div>").addClass(ALL_DAY_PANEL_CLASS);
        ...
        let config = {
            ...
            onInitialized: _ref => {
                ...
                if (useKeyboardDisabled && useNativeEnabled) {
                    (0, _renderer.default)(null === component || void 0 === component ? void 0 : component.container()).attr("tabindex", -1)
                }
            },
    ...
    setTableSizes() {
        ...
        if (width < minWidth) {
            width = minWidth
        }(0, _size.setWidth)(this.$headerPanel, width);
        (0, _size.setWidth)(this.$dateTable, width);
        if (this.$allDayTable) {
    ...
    initVirtualScrolling() {
        ...
        this.virtualScrollingDispatcher = new _virtual_scrolling.VirtualScrollingDispatcher(this.getVirtualScrollingDispatcherOptions());
        this.virtualScrollingDispatcher.attachScrollableEvents();
        this.renderer = new _virtual_scrolling.VirtualScrollingRenderer(this)
    }
    ...
    updateHeaderPanelScrollbarPadding() {
        if ((0, _window.hasWindow)() && this.$headerPanelContainer) {
            const scrollbarWidth = this.getScrollbarWidth();
            this.$headerPanelContainer.css("paddingRight", `${scrollbarWidth}px`)
        }
    }
    getScrollbarWidth() {
        const containerElement = (0, _renderer.default)(this.$dateTableScrollable.container()).get(0);
    ...
    getViewStartByOptions() {
        return (0, _index3.getViewStartByOptions)(this.option().startDate ?? void 0, this.option().currentDate, this.getTotalViewDuration(), this.option().startDate ? this.calculateViewStartDate() : void 0)
    }
    ...
    calculateViewStartDate() {
        return (0, _index3.calculateViewStartDate)(this.option().startDate ?? void 0)
    }
    firstDayOfWeek() {
    ...
    attachClickEvent() {
        ...
        if (this.documentPointerUpHandler) {
            _events_engine.default.off(_dom_adapter.default.getDocument(), SCHEDULER_TABLE_DXPOINTERUP_EVENT_NAME, this.documentPointerUpHandler)
        }
        ...
        _events_engine.default.on(_dom_adapter.default.getDocument(), SCHEDULER_TABLE_DXPOINTERUP_EVENT_NAME, this.documentPointerUpHandler)
    }
    ...
    attachPointerEvents(element) {
        ...
        _events_engine.default.on(element, SCHEDULER_CELL_DXPOINTERDOWN_EVENT_NAME, DRAG_AND_DROP_SELECTOR, e => {
            if (((0, _index.isMouseEvent)(e) || e.originalEvent && (0, _index.isMouseEvent)(e.originalEvent)) && 1 === e.which) {
                isPointerDown = true;
    ...
    getScrollableContainer() {
        return (0, _renderer.default)(this.$dateTableScrollable.container())
    }
    getHeaderPanelHeight() {
        return this.$headerPanel && (0, _size.getOuterHeight)(this.$headerPanel, true)
    }
    getTimePanelWidth() {
        return this.$timePanel && (0, _position.getBoundingRect)(this.$timePanel.get(0)).width
    }
    getGroupTableWidth() {
        return this.$groupTable ? (0, _size.getOuterWidth)(this.$groupTable) : 0
    }
    ...
    getSkippedDaysCount(startDate, days) {
        return (0, _skipped_days.getSkippedDaysCount)(startDate, days, this.option().skippedDays)
    }
    ...
    getWorkSpaceWidth() {
        return this.cache.memo("workspaceWidth", () => {
            if (this.needCreateCrossScrolling()) {
                return (0, _position.getBoundingRect)(this.$dateTable.get(0)).width
            }
    ...
    domGetDateCell(position) {
        return this.$dateTable.find(`tr:not(.${VIRTUAL_ROW_CLASS})`).eq(position.rowIndex).find(`td:not(.${_classes.VIRTUAL_CELL_CLASS})`).eq(position.columnIndex)
    }
    ...
    setHorizontalGroupHeaderCellsHeight() {
        const {
            height: height
        } = (0, _position.getBoundingRect)(this.$dateTable.get(0));
        (0, _size.setOuterHeight)(this.$groupTable, height)
    }
    getGroupHeaderCells() {
    ...
    normalizeCellData(cellData) {
        ...
        return (0, _extend.extend)(true, {}, normalizedCellData)
    }
    ...
    getCellWidth() {
        return (0, _position_helper.getCellWidth)(this.getDOMElementsMetaData())
    }
    getCellHeight() {
        return (0, _position_helper.getCellHeight)(this.getDOMElementsMetaData())
    }
    getAllDayHeight() {
        return (0, _position_helper.getAllDayHeight)(this.option().showAllDayPanel, this.isVerticalGroupedWorkSpace(), this.getDOMElementsMetaData())
    }
    getIndicatorOffset() {
        return 0
    }
    ...
    getMaxAllowedPosition(groupIndex) {
        return (0, _position_helper.getMaxAllowedPosition)(groupIndex, this.viewDataProvider, this.option().rtlEnabled, this.getDOMElementsMetaData())
    }
    getAllDayOffset() {
    ...
    getGroupBounds(coordinates) {
        const groupBounds = this.groupedStrategy instanceof _work_space_grouped_strategy_vertical.default ? this.getGroupBoundsVertical(coordinates.groupIndex ?? 0) : this.getGroupBoundsHorizontal(coordinates);
    ...
    getGroupBoundsHorizontal(coordinates) {
        ...
        if (this.groupedStrategy instanceof _work_space_grouped_strategy_horizontal.default) {
    ...
    renderRDateTable() {
        this.renderRenovatedComponent(this.$dateTable, _index2.DateTableComponent, "renovatedDateTable", this.getRDateTableProps())
    }
    renderRGroupPanel() {
    ...
    renderRAllDayPanel() {
        ...
        if (visible) {
            ...
            if (this.$allDayTable) {
                this.renderRenovatedComponent(this.$allDayTable, _index2.AllDayTableComponent, "renovatedAllDayPanel", options)
            }
            this.renderRenovatedComponent(this.$allDayTitle, _index2.AllDayPanelTitleComponent, "renovatedAllDayPanelTitle", {})
        }
        this.updateAllDayVisibility();
        this.updateScrollable()
    }
    renderRTimeTable() {
        this.renderRenovatedComponent(this.$timePanel, _index2.TimePanelComponent, "renovatedTimePanel", {
            viewContext: this.getR1ComponentsViewContext(),
    ...
    getCellFromPoint(x, y) {
        const elements = _dom_adapter.default.elementsFromPoint(x, y);
        ...
        return cell ? (0, _renderer.default)(cell) : null
    }
    ...
    createDragBehaviorBase(targetElement, rootElement, options) {
        const container = this.$element().find(`.${_classes.FIXED_CONTAINER_CLASS}`);
        if (!this.dragBehavior) {
            return
        }
    ...
    _getDefaultOptions() {
        const defaultOptions = Object.assign({}, super._getDefaultOptions(), {
            ...
            onScrollEnd: _common.noop,
            getHeaderHeight: void 0,
            renderAppointments: _common.noop,
            onShowAllDayPanel: _common.noop,
            onSelectedCellsClick: _common.noop,
    ...
    getVirtualScrollingDispatcherOptions() {
        return {
            ...
            getViewHeight: () => (0, _size.getHeight)(this.$element()),
            getViewWidth: () => (0, _size.getWidth)(this.$element()),
    ...
    initPositionHelper() {
        this.positionHelper = new _position_helper.PositionHelper({
    ...
    initGroupedStrategy() {
        const Strategy = this.isVerticalOrientation() ? _work_space_grouped_strategy_vertical.default : _work_space_grouped_strategy_horizontal.default;
    ...
    initWorkSpaceUnits() {
        this.$headerPanelContainer = (0, _renderer.default)("<div>").addClass("dx-scheduler-header-panel-container");
        this.$headerTablesContainer = (0, _renderer.default)("<div>").addClass("dx-scheduler-header-tables-container");
        this.$headerPanel = (0, _renderer.default)("<table>").attr("aria-hidden", true);
        this.$thead = (0, _renderer.default)("<thead>").appendTo(this.$headerPanel);
        ...
        this.$fixedContainer = (0, _renderer.default)("<div>").addClass(_classes.FIXED_CONTAINER_CLASS);
        ...
        this.createRAllDayPanelElements();
        this.$timePanel = (0, _renderer.default)("<table>").addClass(_classes.TIME_PANEL_CLASS).attr("aria-hidden", true);
        this.$dateTable = (0, _renderer.default)("<table>").attr("aria-hidden", true);
        this.$dateTableContainer = (0, _renderer.default)("<div>").addClass("dx-scheduler-date-table-container");
        this.$groupTable = (0, _renderer.default)("<div>").addClass(WORKSPACE_VERTICAL_GROUP_TABLE_CLASS)
    }
    ...
    initDateTableScrollable() {
        ...
        this.$dateTableScrollable = this._createComponent($dateTableScrollable, _scrollable.default, this.dateTableScrollableConfig());
        this.scrollSync.dateTable = (0, _scroll.getMemoizeScrollTo)(() => this.$dateTableScrollable)
    }
    ...
    createWorkSpaceScrollableElements() {
        ...
        this.$flexContainer = (0, _renderer.default)("<div>").addClass("dx-scheduler-work-space-flex-container");
    ...
    createSidebarScrollable() {
        const $timePanelScrollable = (0, _renderer.default)("<div>").addClass("dx-scheduler-sidebar-scrollable").appendTo(this.$flexContainer);
        this.$sidebarScrollable = this._createComponent($timePanelScrollable, _scrollable.default, {
            useKeyboard: false,
            showScrollbar: "never",
            direction: "vertical",
            useNative: false,
        ...
        this.scrollSync.sidebar = (0, _scroll.getMemoizeScrollTo)(() => this.$sidebarScrollable)
    }
    attachTableClasses() {
        this.addTableClass(this.$dateTable, _classes.DATE_TABLE_CLASS);
        if (this.isVerticalGroupedWorkSpace()) {
            const groupCount = this.getGroupCount();
    ...
    renderView() {
        ...
        this.updateGroupTableHeight();
        this.updateHeaderEmptyCellWidth();
        this.shader = new _current_time_shader_vertical.default(this)
    }
...
const domAdapterExt = _dom_adapter.default;
const createDragBehaviorConfig = (container, rootElement, isDefaultDraggingMode, dragBehavior, enableDefaultDragging, disableDefaultDragging, getDroppableCell, getDateTables, removeDroppableCellClass, getCellWidthCallback, options) => {
    ...
    return {
        ...
        onDragStart: e => {
            ...
            if (!isItemDisabled()) {
                ...
                if (!canceled) {
                    ...
                    e.event.data.initialPosition = initialPosition ?? (0, _translator.locate)((0, _renderer.default)(state.dragElement));
        ...
        onDragCancel: e => {
            ...
            removeDroppableCellClass();
            (0, _renderer.default)(e.itemElement).removeClass(_classes.APPOINTMENT_DRAG_SOURCE_CLASS)
        },
