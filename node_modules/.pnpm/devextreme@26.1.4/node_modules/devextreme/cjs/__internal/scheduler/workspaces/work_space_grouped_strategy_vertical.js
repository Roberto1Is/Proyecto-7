/**
 * DevExtreme (cjs/__internal/scheduler/workspaces/work_space_grouped_strategy_vertical.js)
 * Version: 26.1.4
...
class VerticalGroupedStrategy {
    ...
    getWorkSpaceMinWidth() {
        ...
        const workspaceContainerWidth = workSpaceElementWidth - this.config.getTimePanelWidth() - this.config.getGroupTableWidth() - 2 * _const.WORK_SPACE_BORDER_PX;
    ...
    getDefaultGroupHeight() {
        ...
        return (0, _index.calculateDayDuration)(startDayHour, endDayHour) / hoursInterval * this.config.getCellHeight()
    }
