/**
 * DevExtreme (cjs/__internal/ui/drop_down_editor/drop_down_button.js)
 * Version: 26.1.4
...
class DropDownButton extends _button2.default {
    ...
    _getOptions() {
        ...
        const {
            readOnly: readOnly
        } = (null === editor || void 0 === editor ? void 0 : editor.option()) ?? {};
        const options = {
    ...
    _legacyRender($editor, $element, isVisible) {
        null === $editor || void 0 === $editor || $editor.toggleClass(DROP_DOWN_EDITOR_BUTTON_VISIBLE, isVisible);
        if ($element) {
    ...
    _addTemplate(options) {
        ...
        options.template = null === (_this$editor6 = this.editor) || void 0 === _this$editor6 ? void 0 : _this$editor6._getTemplateByOption("dropDownButtonTemplate");
