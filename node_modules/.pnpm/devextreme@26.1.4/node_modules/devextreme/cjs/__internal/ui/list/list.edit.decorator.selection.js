...
class EditDecoratorSelection extends _listEdit.default {
    ...
    _renderSelectAll() {
        ...
        const {
            selectAllText: selectAllText = _message.default.format("dxList-selectAll")
        } = this._list.option();
    ...
    _updateSelectAllAriaLabel() {
        ...
        const label = `${selectAllText}, ${_message.default.format(`dxList-selectAll-${stateVariableName}`)}`;
