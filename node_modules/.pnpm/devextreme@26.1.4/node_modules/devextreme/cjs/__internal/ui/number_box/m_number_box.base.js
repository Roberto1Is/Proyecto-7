...
exports.default = exports.WIDGET_CLASS = void 0;
...
var _text_editor = _interopRequireDefault(require("../../ui/text_box/text_editor"));
...
const math = Math;
const WIDGET_CLASS = exports.WIDGET_CLASS = "dx-numberbox";
...
class NumberBoxBase extends _text_editor.default {
    _supportedKeys() {
    ...
    _applyDisplayValueFormatter(value) {
        if (!this.option("format")) {
            ...
            if (globalNumberFormat) {
                return _number.default.format(Number(value), globalNumberFormat)
            }
        }
        const {
