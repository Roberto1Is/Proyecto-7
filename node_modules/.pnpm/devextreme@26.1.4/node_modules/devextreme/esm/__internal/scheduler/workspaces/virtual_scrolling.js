/**
 * DevExtreme (esm/__internal/scheduler/workspaces/virtual_scrolling.js)
 * Version: 26.1.4
...
class VirtualScrollingBase {
    ...
    updateState(rawPosition, isForce) {
...
export class VirtualScrollingDispatcher {
    ...
    get verticalScrollingAllowed() {
        ...
        } = this.options.getScrolling();
        return "virtual" === mode && ("vertical" === orientation || "both" === orientation)
    }
    get horizontalScrollingAllowed() {
        ...
        return "virtual" === mode && ("horizontal" === orientation || "both" === orientation)
    }
    setViewOptions(options) {
        this.options = options;
        if (this.verticalVirtualScrolling) {
            this.verticalVirtualScrolling.options = Object.assign({}, options, {
        ...
        if (this.horizontalVirtualScrolling) {
            this.horizontalVirtualScrolling.options = Object.assign({}, options, {
    ...
    updateDimensions() {
        let isForce = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : false;
...
export class VirtualScrollingRenderer {
    ...
    renderAppointments() {
        ...
        if (renderTimeout >= 0) {
            clearTimeout(this.renderAppointmentTimeoutID ?? void 0);
