...
class DateBoxMask extends DateBoxBase {
    ...
    _keyboardHandler(e) {
        ...
        if (browser.chrome && "Process" === e.key && chromiumDigitCodeMatch) {
    ...
    _attachMaskEvents() {
        ...
        eventsEngine.on(this._input(), addNamespace("compositionstart", "dateBoxMask"), this._maskCompositionStartHandler.bind(this));
