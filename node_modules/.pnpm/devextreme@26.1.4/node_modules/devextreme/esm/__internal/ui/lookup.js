/**
 * DevExtreme (esm/__internal/ui/lookup.js)
 * Version: 26.1.4
...
import DropDownList from "../ui/drop_down_editor/drop_down_list";
import {
    getElementWidth
...
class Lookup extends DropDownList {
    ...
    _getDefaultOptions() {
        const getSize = side => {
            if ("phone" === devices.real().deviceType && window.visualViewport) {
                return .8 * window.visualViewport[side]
            }
            const size = "width" === side ? getWidth(window) : getHeight(window);
            return .8 * size
        };
        return Object.assign({}, super._getDefaultOptions(), {
            ...
            onScroll: void 0,
            onPullRefresh: void 0,
            onPageLoading: void 0,
    ...
    _updateField(text) {
        const displayText = isDefined(text) && String(text);
        this._$field.empty();
        if (displayText) {
    ...
    _popupShowingHandler() {
        ...
        } = (null === (_this$_searchBox = this._searchBox) || void 0 === _this$_searchBox ? void 0 : _this$_searchBox.option()) ?? {};
        if (cleanSearchOnOpening) {
            var _this$_list;
            if (searchEnabled && searchBoxValue) {
                var _this$_searchBox2;
                null === (_this$_searchBox2 = this._searchBox) || void 0 === _this$_searchBox2 || _this$_searchBox2.option("value", "");
        ...
        if (fullScreen && _scrollToSelectedItemEnabled) {
            ...
            const {
                position: position
            } = (null === (_this$_popup = this._popup) || void 0 === _this$_popup ? void 0 : _this$_popup.option()) ?? {};
            if (position) {
                position.of = $(window)
            }
        }
    ...
    _scrollToSelectedItem() {
        ...
        const itemsCount = (null === listItems || void 0 === listItems ? void 0 : listItems.length) ?? 0;
        if (0 !== itemsCount) {
            var _this$_list5;
            if (grouped) {
                var _this$_list3;
                null === (_this$_list3 = this._list) || void 0 === _this$_list3 || _this$_list3.scrollToItem({
                    group: itemsCount - 1,
                    item: ((null === listItems || void 0 === listItems ? void 0 : listItems[itemsCount - 1].items.length) ?? 0) - 1
                })
            } else {
                var _this$_list4;
                null === (_this$_list4 = this._list) || void 0 === _this$_list4 || _this$_list4.scrollToItem(itemsCount - 1)
            }
            null === (_this$_list5 = this._list) || void 0 === _this$_list5 || _this$_list5.scrollToItem(selectedIndex)
        }
    }
    _getDifferenceOffsets(selectedListItem) {
        var _selectedListItem$off, _$$offset;
        return ((null === (_selectedListItem$off = selectedListItem.offset()) || void 0 === _selectedListItem$off ? void 0 : _selectedListItem$off.top) ?? 0) - ((null === (_$$offset = $(this.element()).offset()) || void 0 === _$$offset ? void 0 : _$$offset.top) ?? 0)
    }
    _isCenteringEnabled(index, count) {
        return index > 1 && index < count - 2
    }
    _getPopupOffset() {
        var _this$_list6, _$$offset2, _this$_list7;
        const listItemsCount = this._listItemElements().length;
        if (0 === listItemsCount) {
            return
        }
        const selectedListItem = $(null === (_this$_list6 = this._list) || void 0 === _this$_list6 ? void 0 : _this$_list6.element()).find(".dx-list-item-selected");
        ...
        const lookupOffset = (null === (_$$offset2 = $(null === (_this$_list7 = this._list) || void 0 === _this$_list7 ? void 0 : _this$_list7.element()).offset()) || void 0 === _$$offset2 ? void 0 : _$$offset2.top) ?? 0;
        const {
            dropDownOptions: {
                height: dropDownHeightOption
            } = {}
        } = this.option();
        ...
        if (-1 !== selectedIndex) {
            if (this._isCenteringEnabled(selectedIndex, listItemsCount)) {
                ...
                if (lookupOffset < offsetTop && selectedIndex !== listItemsCount - 3) {
                    ...
                    this._list.scrollTo(this._list.scrollTop() + updatedDifferenceOffset / 2);
                    offsetTop = differenceOfHeights + this._getDifferenceOffsets(selectedListItem)
                }
    ...
    _setPopupPosition() {
        ...
        const flipped = null === (_this$_popup2 = this._popup) || void 0 === _this$_popup2 || null === (_this$_popup2 = _this$_popup2.$wrapper()) || void 0 === _this$_popup2 ? void 0 : _this$_popup2.hasClass("dx-popover-flipped-vertical");
        if (flipped) {
            return
        }
        const popupContentParent = $(null === (_this$_popup3 = this._popup) || void 0 === _this$_popup3 ? void 0 : _this$_popup3.$content()).parent();
    ...
    _listItemGroupedElements() {
        const groupsContainer = this._list ? this._list._getItemsContainer().children() : [];
        const groups = Array.from(groupsContainer);
        const items = [];
        groups.forEach(group => {
            items.push($(group).find(".dx-list-group-header")[0]);
            const groupedItems = Array.from($(group).find(".dx-list-item"));
    ...
    _calculateListHeight(grouped) {
        ...
        if (0 === listItems.length) {
            ...
            if (selectedIndex <= 1) {
                ...
                const start = listItems.length - 5;
                requireListItems = listItems.slice(start, listItems.length)
            }
            Array.from(requireListItems).forEach(item => {
                listHeight += getOuterHeight(item)
            })
        }
    ...
    _getPopupHeight() {
        var _this$_list8, _this$_popup4, _this$_popup5;
        const {
            grouped: grouped
        } = this.option();
        ...
        const bottomToolbar = null === (_this$_popup4 = this._popup) || void 0 === _this$_popup4 ? void 0 : _this$_popup4.bottomToolbar();
        const topToolbar = null === (_this$_popup5 = this._popup) || void 0 === _this$_popup5 ? void 0 : _this$_popup5.topToolbar();
        return this._calculateListHeight(grouped) + (this._$searchWrapper ? getOuterHeight(this._$searchWrapper) : 0) + (bottomToolbar ? getOuterHeight(bottomToolbar) : 0) + (topToolbar ? getOuterHeight(topToolbar) : 0)
    }
    ...
    _renderPopup() {
        var _this$_$popup, _this$_popup6;
        const {
            usePopover: usePopover,
            _scrollToSelectedItemEnabled: _scrollToSelectedItemEnabled,
            dropDownOptions: {
        ...
        null === (_this$_$popup = this._$popup) || void 0 === _this$_$popup || _this$_$popup.addClass("dx-lookup-popup");
        null === (_this$_popup6 = this._popup) || void 0 === _this$_popup6 || null === (_this$_popup6 = _this$_popup6.$wrapper()) || void 0 === _this$_popup6 || _this$_popup6.addClass("dx-lookup-popup-wrapper")
    }
    _renderPopover() {
        ...
        const {
            _scrollToSelectedItemEnabled: scrollToSelectedItemEnabledInPopover
        } = this.option();
    ...
    _popupHiddenHandler() {
        ...
        if (_scrollToSelectedItemEnabled) {
            var _this$_popup7;
            resetPosition($(null === (_this$_popup7 = this._popup) || void 0 === _this$_popup7 ? void 0 : _this$_popup7.content()).parent())
        }
    }
    ...
    _shouldLoopFocusInsidePopup() {
        ...
        const result = _scrollToSelectedItemEnabled ? Boolean(dropDownCentered) : !usePopover;
        return result
    }
    _popupConfig() {
        const {
        ...
        const shouldLoopFocusInsidePopup = this._shouldLoopFocusInsidePopup();
        const result = Object.assign({}, super._popupConfig(), {
        ...
        } ["position", "animation", "width", "height"].forEach(optionName => {
    ...
    _renderSearch() {
        ...
        if (isSearchEnabled) {
            this._$searchWrapper = $("<div>").addClass("dx-lookup-search-wrapper");
            const $searchWrapper = this._$searchWrapper;
            this._$searchBox = $("<div>").addClass("dx-lookup-search").appendTo($searchWrapper);
            ...
            const textBoxOptions = {
                ...
                inputAttr: {
                    "aria-label": messageLocalization.format("Search")
                },
                onDisposing: () => {
                    isKeyboardListeningEnabled = false
                },
                onFocusIn: () => {
                    isKeyboardListeningEnabled = true
                },
                onFocusOut: () => {
                    var _this$_list9;
                    isKeyboardListeningEnabled = false;
                    null === (_this$_list9 = this._list) || void 0 === _this$_list9 || _this$_list9.option("focusedElement", null)
                },
                onKeyboardHandled: opts => {
                    if (isKeyboardListeningEnabled) {
                        var _this$_list0;
                        null === (_this$_list0 = this._list) || void 0 === _this$_list0 || _this$_list0._keyboardHandler(opts)
                    }
                },
                onValueChanged: () => {
                    this._searchHandler()
    ...
    _filterDataSource(searchValue) {
        if (this._list && !this._list._dataSource && this._isMinSearchLengthExceeded()) {
            var _this$_list1;
            null === (_this$_list1 = this._list) || void 0 === _this$_list1 || _this$_list1._scrollView.startLoading()
        }
    ...
    _selectListItemHandler(e) {
        ...
        } = (null === (_this$_list11 = this._list) || void 0 === _this$_list11 ? void 0 : _this$_list11.option()) ?? {};
        ...
        this._selectListItem(void 0, $itemElement)
    }
    _registerSearchKeyHandlers() {
        var _this$_searchBox3, _this$_searchBox4, _this$_searchBox5, _this$_searchBox6;
        null === (_this$_searchBox3 = this._searchBox) || void 0 === _this$_searchBox3 || _this$_searchBox3.registerKeyHandler("enter", this._selectListItemHandler.bind(this));
        null === (_this$_searchBox4 = this._searchBox) || void 0 === _this$_searchBox4 || _this$_searchBox4.registerKeyHandler("space", this._selectListItemHandler.bind(this));
        null === (_this$_searchBox5 = this._searchBox) || void 0 === _this$_searchBox5 || _this$_searchBox5.registerKeyHandler("end", noop);
        null === (_this$_searchBox6 = this._searchBox) || void 0 === _this$_searchBox6 || _this$_searchBox6.registerKeyHandler("home", noop)
    }
    _toggleSearchClass(isSearchEnabled) {
        if (this._popup) {
            var _this$_popup$$wrapper;
            null === (_this$_popup$$wrapper = this._popup.$wrapper()) || void 0 === _this$_popup$$wrapper || _this$_popup$$wrapper.toggleClass("dx-lookup-popup-search", isSearchEnabled)
        }
    }
    _setSearchPlaceholder() {
        ...
        null === (_this$_searchBox7 = this._searchBox) || void 0 === _this$_searchBox7 || _this$_searchBox7.option("placeholder", placeholder)
    }
    ...
    _listConfig() {
        ...
        return Object.assign({}, super._listConfig(), {
    ...
    _runWithoutCloseOnScroll(callback) {
        ...
        } = (null === (_this$_popup8 = this._popup) || void 0 === _this$_popup8 ? void 0 : _this$_popup8.option()) ?? {};
        if (!_scrollToSelectedItemEnabled) {
            callback()
        } else {
            var _this$_popup9;
            null === (_this$_popup9 = this._popup) || void 0 === _this$_popup9 || _this$_popup9.option("hideOnParentScroll", false);
            callback();
            this._hideOnParentScrollTimer = setTimeout(() => {
                var _this$_popup0;
                null === (_this$_popup0 = this._popup) || void 0 === _this$_popup0 || _this$_popup0.option("hideOnParentScroll", hideOnParentScroll)
            })
        }
    }
    _setFocusPolicy() {
        ...
        this._runWithoutCloseOnScroll(() => {
            if (searchEnabled) {
                ...
                null === (_this$_searchBox8 = this._searchBox) || void 0 === _this$_searchBox8 || _this$_searchBox8.focus()
            } else {
                var _this$_list12;
                null === (_this$_list12 = this._list) || void 0 === _this$_list12 || _this$_list12.focus()
            }
        })
    }
    _focusTarget() {
    ...
    _listItemClickHandler(e) {
        ...
        this._selectListItem(e.itemData, null === (_e$event = e.event) || void 0 === _e$event ? void 0 : _e$event.currentTarget)
    }
    _selectListItem(itemData, target) {
        if (target) {
            var _this$_list13;
            null === (_this$_list13 = this._list) || void 0 === _this$_list13 || _this$_list13.selectItem(target)
        }
        const {
            applyValueMode: applyValueMode
        } = this.option();
    ...
    _currentSelectedItem() {
        ...
        } = (null === (_this$_list14 = this._list) || void 0 === _this$_list14 ? void 0 : _this$_list14.option()) ?? {};
        return grouped ? null === firstSelectedItem || void 0 === firstSelectedItem ? void 0 : firstSelectedItem.items[0] : firstSelectedItem
    }
    _resetValue(e) {
        this._saveValueChangeEvent(e.event);
    ...
    _searchValue() {
        var _this$_searchBox9;
        const {
            searchEnabled: searchEnabled
        } = this.option();
        const {
            value: searchBoxValue
        } = (null === (_this$_searchBox9 = this._searchBox) || void 0 === _this$_searchBox9 ? void 0 : _this$_searchBox9.option()) ?? {};
        return searchEnabled && this._searchBox ? searchBoxValue : ""
    }
    _renderInputValue() {
        let arg = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
    ...
    _optionChanged(args) {
        ...
        switch (name) {
            ...
            case "searchStartEvent":
                null === (_this$_searchBox0 = this._searchBox) || void 0 === _this$_searchBox0 || _this$_searchBox0.option("valueChangeEvent", value);
                break;
            case "onScroll":
                this._initScrollAction();
                break;
            ...
            case "dropDownOptions":
                switch (fullName) {
                    ...
                    case "dropDownOptions.height": {
                        const optionArgs = Object.assign({}, args, {
