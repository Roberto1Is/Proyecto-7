...
const GestureEmitter = _emitter.default.inherit({
    ...
    start(e) {
        const isMacContextMenuClick = (0, _index.isMouseEvent)(e) && Boolean(e.ctrlKey) && _m_devices.default.real().mac;
        if (e._needSkipEvent || (0, _index.needSkipEvent)(e) || isMacContextMenuClick) {
            this._cancel(e);
            return
        }
