...
class FilterBuilder extends _ui3.default {
    _getDefaultOptions() {
        return (0, _extend.extend)(super._getDefaultOptions(), {
            onEditorPreparing: void 0,
            onEditorPrepared: void 0,
    ...
    _dimensionChanged() {
        ...
        const positionOf = null === (_this$_popupWithTreeV = this._popupWithTreeView) || void 0 === _this$_popupWithTreeV || null === (_this$_popupWithTreeV = _this$_popupWithTreeV.option("position")) || void 0 === _this$_popupWithTreeV ? void 0 : _this$_popupWithTreeV.of;
        if (positionOf) {
            var _this$_popupWithTreeV2;
            null === (_this$_popupWithTreeV2 = this._popupWithTreeView) || void 0 === _this$_popupWithTreeV2 || _this$_popupWithTreeV2.option("maxHeight", (0, _utils.getElementMaxHeightByWindow)(positionOf))
        }
    }
    _createPopupWithTreeView(options, $container) {
        ...
        this._popupWithTreeView = this._createComponent($popup, _ui.default, {
            onHiding: options.menu.onHiding,
            onHidden: function() {
                for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
                    args[_key] = arguments[_key]
                }
                null === onHidden || void 0 === onHidden || onHidden(...args);
