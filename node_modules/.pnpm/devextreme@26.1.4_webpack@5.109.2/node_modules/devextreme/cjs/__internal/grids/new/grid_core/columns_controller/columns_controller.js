...
var _index3 = require("./columns_settings/index");
...
class ColumnsController {
    constructor(options) {
        ...
        (0, _index.effect)(() => {
            ...
            const newSettings = (0, _index3.updateColumnSettings)(settings, changes);
    ...
    columnOption(column, option, value) {
        ...
        const prevValue = (0, _index2.getTreeNodeByPath)(column, (0, _data.getPathParts)(option));
    ...
    updateColumns(func) {
        ...
        newColumns.forEach((newColumn, columnIdx) => {
            const prevColumn = (0, _utils2.getColumnByIndexOrName)(prevColumns, newColumn.name);
            if (prevColumn) {
                const options = new Set([...Object.keys(prevColumn), ...Object.keys(newColumn)]);
                for (const option of options) {
                    if (!_const.IGNORE_COLUMN_OPTION_NAMES[option]) {
    ...
    fireOptionChanged(columnIndex, optionName, newValue, prevValue) {
        if (!(0, _common.equalByValue)(prevValue, newValue, {
                maxDepth: _const.COLUMNS_OBJ_COMPARE_DEPTH
            })) {
