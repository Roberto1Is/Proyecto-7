...
const getGlobalFormat = dataType => {
    ...
    if ((0, _type.isString)(globalFormat)) {
        return value => {
...
const getGlobalColumnFormat = dataType => {
    if ("date" === dataType || "datetime" === dataType) {
...
function normalizeColumn(column, templateNormalizationFunc, columnFromDataOptions) {
    ...
    const shouldUseInferredFormat = void 0 === column.dataType || (null === columnFromDataOptions || void 0 === columnFromDataOptions ? void 0 : columnFromDataOptions.dataType) === dataType;
    const columnFormat = column.format ?? (shouldUseInferredFormat ? null === columnFromDataOptions || void 0 === columnFromDataOptions ? void 0 : columnFromDataOptions.format : void 0) ?? getGlobalColumnFormat(dataType) ?? (null === columnDataTypeDefaultOptions || void 0 === columnDataTypeDefaultOptions ? void 0 : columnDataTypeDefaultOptions.format);
