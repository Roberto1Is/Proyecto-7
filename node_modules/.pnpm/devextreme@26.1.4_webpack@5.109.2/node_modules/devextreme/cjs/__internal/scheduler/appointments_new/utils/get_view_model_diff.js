...
const getViewModelDiff = (oldViewModel, newViewModel, appointmentDataSource) => {
    const result = getArraysDiff({
        ...
        b: newViewModel,
        match: (a, b) => {
            if ((0, _type_helpers.isCollectorViewModel)(a) || (0, _type_helpers.isCollectorViewModel)(b)) {
                return (0, _type_helpers.isCollectorViewModel)(a) && (0, _type_helpers.isCollectorViewModel)(b) && (0, _common.equalByValue)(getObjectToCompare(a, false), getObjectToCompare(b, false))
            }
            return a.itemData === b.itemData && !isAppointmentDataChanged(b.itemData, appointmentDataSource)
        },
        ...
        itemsEqual: (a, b) => {
            ...
            return a.items.length === b.items.length && !b.items.some(item => isAppointmentDataChanged(item.itemData, appointmentDataSource))
        }
    });
    return result
};
