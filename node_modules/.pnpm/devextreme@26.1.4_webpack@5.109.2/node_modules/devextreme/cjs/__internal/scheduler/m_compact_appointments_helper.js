...
class CompactAppointmentsHelper {
    ...
    getExtraOptionsForTooltip(options, $appointmentCollector) {
        return {
            ...
            dragBehavior: options.allowDrag ? this.createTooltipDragBehavior($appointmentCollector).bind(this) : void 0,
            isButtonClick: true,
    ...
    createTooltipDragBehavior($appointmentCollector) {
        return e => {
            ...
            null === workSpace || void 0 === workSpace || workSpace.createDragBehaviorBase($element, $schedulerElement, options)
        }
    }
    ...
    localizeDate(date) {
        return (0, _global_formats.formatImplicitSchedulerDate)(date)
    }
