...
var _get_occurrences = require("./filtration/get_occurrences");
...
class AppointmentLayoutManager {
    ...
    getOccurrences(startDate, endDate, rawAppointments) {
        const preparedAppointments = (0, _prepare_appointments.prepareAppointments)(this.schedulerStore, rawAppointments);
        const occurrences = (0, _get_occurrences.getOccurrences)(this.schedulerStore, startDate, endDate, preparedAppointments);
        return occurrences
    }
