/**
 * DevExtreme (cjs/__internal/scheduler/workspaces/view_model/view_data_generator_month.js)
 * Version: 26.1.4
...
class ViewDataGeneratorMonth extends _view_data_generator.ViewDataGenerator {
    constructor() {
        super(...arguments);
    ...
    getCellData(rowIndex, columnIndex, options) {
        ...
        const startDate = _utils_time_zone.default.addOffsetsWithoutDST(data.startDate, -viewOffset);
