...
class DateBoxMask extends _date_box.default {
    ...
    _isSingleDigitKey(e) {
        ...
        return 1 === (null === data || void 0 === data ? void 0 : data.length) && !isNaN(parseInt(data, 10))
    }
    ...
    _keyboardHandler(e) {
        ...
        if (_browser.default.chrome && "Process" === e.key && chromiumDigitCodeMatch) {
    ...
    _keyPressHandler(e) {
        ...
        const isBackwardDeletion = "deleteContentBackward" === (null === event || void 0 === event ? void 0 : event.inputType);
        const isForwardDeletion = "deleteContentForward" === (null === event || void 0 === event ? void 0 : event.inputType);
        ...
        const isCompositionDigit = "insertCompositionText" === (null === event || void 0 === event ? void 0 : event.inputType) && this._isSingleDigitKey(e);
        const isIMECommitDigit = "insertText" === (null === event || void 0 === event ? void 0 : event.inputType) && this._isSingleDigitKey(e) && this._isIMECommitPending;
    ...
    _attachMaskEvents() {
        ...
        _events_engine.default.on(this._input(), (0, _index.addNamespace)("compositionstart", "dateBoxMask"), this._maskCompositionStartHandler.bind(this));
