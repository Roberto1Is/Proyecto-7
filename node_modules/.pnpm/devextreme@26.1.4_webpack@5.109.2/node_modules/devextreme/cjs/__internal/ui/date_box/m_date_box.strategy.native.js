...
class NativeStrategy extends _m_date_box.default {
    ...
    getDisplayFormat(displayFormat) {
        ...
        const globalFormat = "date" === type || "datetime" === type || "datetime-local" === type ? (0, _m_global_format_config.getGlobalFormatByDataType)("datetime-local" === type ? "datetime" : type) : void 0;
        return displayFormat || globalFormat || _date_utils.default.FORMATS_MAP[type]
    }
