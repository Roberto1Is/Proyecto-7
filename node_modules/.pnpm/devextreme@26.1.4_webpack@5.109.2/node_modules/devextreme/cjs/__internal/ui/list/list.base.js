...
class ListBase extends _collection_widget.default {
    ...
    _initScrollView() {
        ...
        this._scrollView = this._createComponent(this.$element(), getScrollView(), {
            ...
            onPullDown: isPullRefreshEnabled ? this._pullDownHandler.bind(this) : void 0,
            onReachBottom: autoPagingEnabled ? this._scrollBottomHandler.bind(this) : void 0,
            showScrollbar: showScrollbar,
    ...
    _renderEmptyMessage(rootNodes) {
        ...
        this.setAria({
            role: isEmpty ? void 0 : "application"
        }, this._focusTarget());
        return isEmpty
    }
    _isMultiSelectMode() {
    ...
    _postprocessRenderItem(args) {
        ...
        this._updateSwipeEventSubscription((0, _renderer.default)(args.itemElement))
    }
    _getElementClassToSkipRefreshId() {
        return "dx-list-group-header"
    }
    _updateSwipeEventSubscription() {
        let $itemElement = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this._itemElements();
        const endEventName = (0, _utils.addNamespace)(_swipe.end, this.NAME);
        _events_engine.default.off($itemElement, endEventName);
    ...
    on(eventName, eventHandler) {
        ...
        const hasItemSwipeHandler = "itemSwipe" === eventName || (0, _type.isPlainObject)(eventName) && Object.prototype.hasOwnProperty.call(eventName, "itemSwipe");
