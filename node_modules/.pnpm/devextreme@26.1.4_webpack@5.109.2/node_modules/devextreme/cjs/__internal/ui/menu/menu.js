...
class Menu extends _menu_base.default {
    _getDefaultOptions() {
        return Object.assign({}, super._getDefaultOptions(), {
            ...
            onSubmenuShowing: void 0,
            onSubmenuShown: void 0,
            onSubmenuHiding: void 0,
            onSubmenuHidden: void 0,
    ...
    _dimensionChanged() {
        ...
        null === (_this$_overlay = this._overlay) || void 0 === _this$_overlay || _this$_overlay.option("maxHeight", (0, _utils2.getElementMaxHeightByWindow)(this.$element()))
    }
    _init() {
        super._init();
        this._submenus = []
    ...
    _toggleTreeView(visible) {
        var _this$_overlay2, _this$_overlay3;
        const isTreeViewVisible = visible ?? !(null !== (_this$_overlay2 = this._overlay) && void 0 !== _this$_overlay2 && null !== (_this$_overlay2 = _this$_overlay2.option()) && void 0 !== _this$_overlay2 && _this$_overlay2.visible);
        null === (_this$_overlay3 = this._overlay) || void 0 === _this$_overlay3 || _this$_overlay3.option("visible", isTreeViewVisible);
    ...
    _getTreeViewOptions() {
        ...
        return Object.assign({}, menuOptions, {
            ...
            onItemExpanded: e => {
                var _this$_overlay4, _this$_actions$onSubm, _this$_actions;
            ...
            onItemCollapsed: e => {
                var _this$_overlay5, _this$_actions$onSubm2, _this$_actions2;
                null === (_this$_overlay5 = this._overlay) || void 0 === _this$_overlay5 || _this$_overlay5.repaint();
    ...
    _optionChanged(args) {
        ...
        switch (args.name) {
            ...
            case "width":
                if (this._isAdaptivityEnabled()) {
                    var _this$_treeView3, _this$_overlay6;
                    null === (_this$_treeView3 = this._treeView) || void 0 === _this$_treeView3 || _this$_treeView3.option(args.name, args.value);
                    null === (_this$_overlay6 = this._overlay) || void 0 === _this$_overlay6 || _this$_overlay6.option(args.name, args.value)
                }
