...
const isCommonPosition = position => (0, _type.isString)(position) && Object.prototype.hasOwnProperty.call(POPOVER_POSITION_ALIASES, position);
exports.isCommonPosition = isCommonPosition;
class PopoverPositionController extends _popup_position_controller.PopupPositionController {
    constructor(params) {
        super(params);
    ...
    _positionToObject(position) {
        if (isCommonPosition(position)) {
            return Object.assign({}, POPOVER_POSITION_ALIASES[position])
        }
