...
exports.default = exports.TOGGLE_ITEM_VISIBILITY_CLASS = exports.SELECT_ALL_ITEM_CLASS = exports.OPENED_NODE_CONTAINER_CLASS = exports.NODE_CONTAINER_CLASS = exports.NODE_CLASS = exports.ITEM_CONTENT_CLASS = exports.ITEM_CLASS = exports.EXPANDER_ICON_STUB_CLASS = exports.DISABLED_STATE_CLASS = exports.CUSTOM_EXPAND_ICON_CLASS = exports.CUSTOM_COLLAPSE_ICON_CLASS = exports.CHECK_BOX_CLASS = void 0;
...
const NODE_CLASS = exports.NODE_CLASS = `${WIDGET_CLASS}-node`;
const NODE_CONTAINER_CLASS = exports.NODE_CONTAINER_CLASS = `${NODE_CLASS}-container`;
const NODE_LOAD_INDICATOR_CLASS = `${NODE_CLASS}-loadindicator`;
const OPENED_NODE_CONTAINER_CLASS = exports.OPENED_NODE_CONTAINER_CLASS = `${NODE_CLASS}-container-opened`;
const IS_LEAF = `${NODE_CLASS}-is-leaf`;
const ITEM_CLASS = exports.ITEM_CLASS = `${WIDGET_CLASS}-item`;
const ITEM_CONTENT_CLASS = exports.ITEM_CONTENT_CLASS = `${WIDGET_CLASS}-item-content`;
...
const CUSTOM_COLLAPSE_ICON_CLASS = exports.CUSTOM_COLLAPSE_ICON_CLASS = `${WIDGET_CLASS}-custom-collapse-icon`;
const CUSTOM_EXPAND_ICON_CLASS = exports.CUSTOM_EXPAND_ICON_CLASS = `${WIDGET_CLASS}-custom-expand-icon`;
...
class TreeViewBase extends _hierarchical_collection_widget.default {
    ...
    _postprocessRenderItem(args) {
        ...
        if (null !== node && void 0 !== node && node.internalFields.disabled) {
            const $itemContent = (0, _renderer.default)(itemElement).find(`.${ITEM_CONTENT_CLASS}`);
            (0, _renderer.default)(itemElement).removeClass(DISABLED_STATE_CLASS);
            (0, _renderer.default)(itemElement).removeAttr("aria-disabled");
    ...
    _updateItemSelection(value, itemElement, event) {
        ...
        if ("never" === disabledNodeSelectionMode && node.internalFields.disabled) {
            return false
        }
    ...
    _processItemClick(e, $item) {
        ...
        const node = this._getNodeByElement($item);
        if (!node || node.internalFields.disabled) {
            return
        }
    ...
    _collapseFocusedContainer() {
        ...
        if (!$focusedNode.hasClass(IS_LEAF) && nodeElement.hasClass(OPENED_NODE_CONTAINER_CLASS)) {
            ...
            if ($closestParentNode.length) {
                this.option("focusedElement", (0, _element.getPublicElement)($closestParentNode))
            }
