...
const compileCriteria = (() => {
    ...
    const compileBinary = criteria => {
        ...
        return formatter(serializePropName(fieldName), serializeValue(value, protocolVersion, null === (_fieldTypes2 = fieldTypes) || void 0 === _fieldTypes2 ? void 0 : _fieldTypes2[fieldName]))
    };
