...
class DataController {
    ...
    getColumnIndexOffset() {
        return this._columnsScrollController ? this._columnsScrollController.beginPageIndex() * this._columnsScrollController.pageSize() : 0
    }
    getRowIndexOffset() {
        return this._rowsScrollController ? this._rowsScrollController.beginPageIndex() * this._rowsScrollController.pageSize() : 0
    }
