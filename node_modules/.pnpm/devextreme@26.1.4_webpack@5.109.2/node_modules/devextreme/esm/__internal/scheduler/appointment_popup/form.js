/**
 * DevExtreme (esm/__internal/scheduler/appointment_popup/form.js)
 * Version: 26.1.4
...
export class AppointmentForm {
    ...
    create(popup) {
        ...
        const customizedItems = customizeFormItems(items, null === (_this$getEditingForm = this.getEditingForm()) || void 0 === _this$getEditingForm ? void 0 : _this$getEditingForm.items);
    ...
    getIconsShowMode() {
        ...
        return (null === (_this$getEditingForm2 = this.getEditingForm()) || void 0 === _this$getEditingForm2 ? void 0 : _this$getEditingForm2.iconsShowMode) ?? DEFAULT_ICONS_SHOW_MODE
    }
    createForm(items) {
        const element = $("<div>");
    ...
    createDateGroup(dateExpr, groupItemOptions, dateItemOptions, timeItemOptions, timezoneItemOptions) {
        ...
        return Object.assign({
            ...
            items: [{
                ...
                items: [extend(true, getStartDateCommonConfig(this.config.firstDayOfWeek), {
                    editorOptions: {
                        onValueChanged: e => {
