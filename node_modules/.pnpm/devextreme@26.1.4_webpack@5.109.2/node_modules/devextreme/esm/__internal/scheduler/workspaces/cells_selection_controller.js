/**
 * DevExtreme (esm/__internal/scheduler/workspaces/cells_selection_controller.js)
 * Version: 26.1.4
...
export class CellsSelectionController {
    handleArrowClick(options) {
        ...
        let nextCellIndices = focusedCellPosition;
        switch (key) {
            case "down":
    ...
    moveToCell(options) {
        const {
            ...
            focusedCellData: focusedCellData,
            currentCellData: currentCellData,
            isVirtualCell: isVirtualCell
        } = options;
        const isValidMultiSelection = isMultiSelection && isMultiSelectionAllowed;
        const nextFocusedCellData = isValidMultiSelection ? this.getNextCellData(currentCellData, focusedCellData, isVirtualCell) : currentCellData;
