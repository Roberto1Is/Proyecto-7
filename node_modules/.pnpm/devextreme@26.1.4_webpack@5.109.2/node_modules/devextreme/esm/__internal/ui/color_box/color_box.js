/**
 * DevExtreme (esm/__internal/ui/color_box/color_box.js)
 * Version: 26.1.4
...
class ColorBox extends DropDownEditor {
    ...
    _enterKeyHandler(e) {
        ...
        if (newValue !== oldValue) {
            ...
            this.option("value", editAlphaChannel ? colorUtils.makeRgba(new Color(newValue)) : newValue)
        }
        if (this._colorView) {
            const {
                value: colorViewValue
