...
export const isCommonPosition = position => isString(position) && Object.prototype.hasOwnProperty.call(POPOVER_POSITION_ALIASES, position);
export class PopoverPositionController extends PopupPositionController {
    constructor(params) {
        super(params);
