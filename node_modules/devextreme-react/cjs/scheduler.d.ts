...
declare const TabPanelOptions: ((props: ITabPanelOptionsProps) => React.FunctionComponentElement<React.PropsWithChildren<{
    ...
    onItemClick?: ((e: TabPanelItemClickEvent) => void) | undefined;
    ...
    onSelectionChanged?: ((e: TabPanelSelectionChangedEvent) => void) | undefined;
...
declare const View: ((props: IViewProps) => React.FunctionComponentElement<React.PropsWithChildren<{
    ...
    snapToCellsMode?: SnapToCellsMode | undefined;
    startDate?: Date | number | string | undefined;
...
export { Scheduler, ISchedulerOptions, SchedulerRef, AIOptions, IAIOptionsProps, AppointmentDragging, IAppointmentDraggingProps, AsyncRule, IAsyncRuleProps, ButtonItem, IButtonItemProps, ButtonOptions, IButtonOptionsProps, ColCountByScreen, IColCountByScreenProps, CompareRule, ICompareRuleProps, CustomRule, ICustomRuleProps, Editing, IEditingProps, EmailRule, IEmailRuleProps, EmptyItem, IEmptyItemProps, Form, IFormProps, GroupItem, IGroupItemProps, Item, IItemProps, Label, ILabelProps, NumericRule, INumericRuleProps, Options, IOptionsProps, OptionsItem, IOptionsItemProps, PatternRule, IPatternRuleProps, RangeRule, IRangeRuleProps, RequiredRule, IRequiredRuleProps, Resource, IResourceProps, Scrolling, IScrollingProps, SimpleItem, ISimpleItemProps, StringLengthRule, IStringLengthRuleProps, Tab, ITabProps, TabbedItem, ITabbedItemProps, TabPanelOptions, ITabPanelOptionsProps, TabPanelOptionsItem, ITabPanelOptionsItemProps, Toolbar, IToolbarProps, ToolbarItem, IToolbarItemProps, ValidationRule, IValidationRuleProps, View, IViewProps };
