...
class DataSourceAdapter extends _m_modules.default.Controller {
    ...
    setCachedStoreData(data) {
        this._cachedStoreData = data;
        this._dataIndexByKey = void 0
    }
    resetCache() {
        this.setCachedStoreData(void 0);
            ...
            this._dataIndexGetter = data => {
                if (!this._dataIndexByKey) {
                    ...
                    for (let i = 0; i < storeData.length; i++) {
                        this._dataIndexByKey[(0, _common.getKeyHash)(store.keyOf(storeData[i]))] = i
                    }
                }
                return this._dataIndexByKey[(0, _common.getKeyHash)(store.keyOf(data))]
            }
        }
    ...
    _calculateOperationTypes(loadOptions, lastLoadOptions, isFullReload) {
        return (0, _m_data_source_adapter_utils.calculateOperationTypes)(loadOptions, lastLoadOptions, isFullReload)
    }
    ...
    _handleDataLoaded(options) {
        ...
        if (!needPageCache || !(0, _m_data_source_adapter_utils.getPageDataFromCache)(options)) {
            ...
            if (needPagingCache && options.cachedPagingData) {
                ...
                if (needStoreCache) {
                    if (!this._cachedStoreData) {
                        this.setCachedStoreData((0, _m_data_source_adapter_utils.cloneItems)(options.data, _m_utils.default.normalizeSortingInfo(storeLoadOptions.group).length))
