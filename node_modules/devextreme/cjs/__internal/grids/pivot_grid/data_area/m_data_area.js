...
class DataArea extends _m_area_item.AreaItem {
    ...
    _makeFirstCellFocusable() {
        var _this$tableElement$ge;
        const firstCell = null === (_this$tableElement$ge = this.tableElement().get(0)) || void 0 === _this$tableElement$ge ? void 0 : _this$tableElement$ge.querySelector("td");
        if (firstCell) {
            (0, _accessibility.setTabIndex)(this.component, (0, _renderer.default)(firstCell))
        }
    }
    _createGroupElement() {
