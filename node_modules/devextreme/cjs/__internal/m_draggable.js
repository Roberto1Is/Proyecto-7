...
class Draggable extends _dom_component.default {
    ...
    _attachEventHandlers() {
        ...
        _events_engine.default.on($element, DRAG_EVENT_NAME, data, this.dragMoveHandler.bind(this));
    ...
    _allowNativeScrollingWhenNotDragging(e) {
        if (!this.dragInProgress) {
            e._cancelPreventDefault = true
        }
    }
    _moveDragElement(e) {
        var _e$offset, _e$offset2;
        const offset = this._getDraggableElementOffset((null === (_e$offset = e.offset) || void 0 === _e$offset ? void 0 : _e$offset.x) ?? 0, (null === (_e$offset2 = e.offset) || void 0 === _e$offset2 ? void 0 : _e$offset2.y) ?? 0);
        this._move(offset)
    }
    _updateScrollable(e) {
        const that = this;
