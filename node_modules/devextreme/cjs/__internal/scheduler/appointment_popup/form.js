/**
 * DevExtreme (cjs/__internal/scheduler/appointment_popup/form.js)
 * Version: 26.1.4
...
var _customize_form_items = require("./customize_form_items");
var _localized_items = require("./localized_items");
var _recurrence_form = require("./recurrence_form");
...
class AppointmentForm {
    ...
    create(popup) {
        var _this$getEditingForm;
        this._popup = popup;
        const mainGroup = this.createMainFormGroup();
        this.recurrenceForm = new _recurrence_form.RecurrenceForm({
        ...
        const customizedItems = (0, _customize_form_items.customizeFormItems)(items, null === (_this$getEditingForm = this.getEditingForm()) || void 0 === _this$getEditingForm ? void 0 : _this$getEditingForm.items);
        this.createForm(customizedItems)
    }
    getEditingForm() {
        const editing = this.getEditingObject();
        return null === editing || void 0 === editing ? void 0 : editing.form
    }
    getEditingObject() {
        const {
            editing: editing
        } = this.config;
        if ((0, _type.isBoolean)(editing) || !editing) {
            return
        }
        return editing
    }
    getIconsShowMode() {
        var _this$getEditingForm2;
        return (null === (_this$getEditingForm2 = this.getEditingForm()) || void 0 === _this$getEditingForm2 ? void 0 : _this$getEditingForm2.iconsShowMode) ?? _constants.DEFAULT_ICONS_SHOW_MODE
    }
    createForm(items) {
        const element = (0, _renderer.default)("<div>");
        const _ref = this.getEditingForm() ?? {},
            {
        ...
        const defaultOptions = {
            ...
            onFieldDataChanged: e => {
                ...
                if (isResourceChanged) {
                    this.updateSubjectIconColor().catch(_common.noop)
                }
            },
            onInitialized: e => {
        ...
        return this.config.createComponent(element, _form.default, formOptions)
    }
    createMainFormGroup() {
        return {
            name: "mainGroup",
    ...
    createDateGroup(dateExpr, groupItemOptions, dateItemOptions, timeItemOptions, timezoneItemOptions) {
        var _this$getEditingObjec;
        const allowTimeZoneEditing = null === (_this$getEditingObjec = this.getEditingObject()) || void 0 === _this$getEditingObjec ? void 0 : _this$getEditingObjec.allowTimeZoneEditing;
        const {
            startDateExpr: startDateExpr,
            endDateExpr: endDateExpr
        } = this.config.dataAccessors.expr;
        ...
        return Object.assign({
            ...
            items: [{
                ...
                items: [(0, _extend.extend)(true, (0, _utils.getStartDateCommonConfig)(this.config.firstDayOfWeek), {
                    editorOptions: {
                        onValueChanged: e => {
    ...
    showMainGroup() {
        var _this$getEditingObjec2;
        const currentHeight = this.dxPopup.option("height");
        const configuredHeight = (null === (_this$getEditingObjec2 = this.getEditingObject()) || void 0 === _this$getEditingObjec2 || null === (_this$getEditingObjec2 = _this$getEditingObjec2.popup) || void 0 === _this$getEditingObjec2 ? void 0 : _this$getEditingObjec2.height) ?? "auto";
    ...
    showRecurrenceGroup() {
        ...
        if (repeatEditor instanceof _drop_down_editor.default) {
            repeatEditor.close()
        }
