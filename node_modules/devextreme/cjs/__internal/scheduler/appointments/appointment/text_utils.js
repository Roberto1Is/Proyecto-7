...
var _global_formats = require("../../utils/global_formats");
...
const localizeDate = date => (0, _global_formats.formatImplicitSchedulerDate)(date);
const localizeTime = date => (0, _global_formats.formatImplicitSchedulerTime)(date);
...
const getGroupText = options => {
    ...
    return _message.default.format("dxScheduler-appointmentAriaDescription-group", groupText)
};
...
const getAriaDescription = async options => {
    ...
    const text = [getGroupText(options), ...resources, options.allowDelete ? _message.default.format("dxScheduler-hotkeysAriaDescription-delete") : null, _message.default.format("dxScheduler-hotkeysAriaDescription-homeEnd")].filter(Boolean).join("; ");
    return text
};
