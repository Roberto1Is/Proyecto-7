...
const createTimeZoneCalculator = currentTimeZone => new _calculator.TimeZoneCalculator({
    ...
    getClientOffset: date => _utils_time_zone.default.getClientTimezoneOffset(date),
    tryGetCommonOffset: date => _utils_time_zone.default.calculateTimezoneByValue(currentTimeZone, date),
    tryGetAppointmentOffset: (date, appointmentTimezone) => _utils_time_zone.default.calculateTimezoneByValue(appointmentTimezone, date)
});
