...
class Accordion extends _collection_widget.default {
    ...
    _updateItemHeight($item, itemHeight, skipAnimation) {
        ...
        $item.css("overflow", "");
        $item.children(".dx-accordion-item-body").css("overflow", "");
    ...
    _animateItem($element, startHeight, endHeight, skipAnimation, fixedHeight) {
        ...
        return deferred.done(() => {
            ...
            if ($element.hasClass("dx-accordion-item-opened")) {
                $element.css("overflow", "visible");
                $element.children(".dx-accordion-item-body").css("overflow", "visible")
            }
