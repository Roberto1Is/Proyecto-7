...
var _suggestions = _interopRequireDefault(require("../../ui/chat/suggestions"));
...
class Chat extends _widget.default {
    _getDefaultOptions() {
        return Object.assign({}, super._getDefaultOptions(), {
            ...
            alerts: [],
            dataSource: null,
            dayHeaderFormat: (0, _m_global_format_config.getGlobalFormatByDataType)("date") ?? "shortdate",
            editing: {
                allowUpdating: false,
                allowDeleting: false
            },
            ...
            messageTimestampFormat: (0, _m_global_format_config.getGlobalFormatByDataType)("time") ?? "shorttime",
            reloadOnChange: true,
            showAvatar: true,
            showDayHeaders: true,
    ...
    _renderSuggestions() {
        this._suggestions = new _suggestions.default(this.$element(), this._getSuggestionsConfiguration())
    }
    _renderMessageBox() {
        const {
            activeStateEnabled: activeStateEnabled,
        ...
        const configuration = {
            ...
            onTextChanged: e => {
                ...
                null === (_this$_inputFieldText = this._inputFieldTextChangedAction) || void 0 === _this$_inputFieldText || _this$_inputFieldText.call(this, e)
            }
        };
    ...
    _createInputFieldTextChangedAction() {
        this._inputFieldTextChangedAction = this._createActionByOption("onInputFieldTextChanged", {
            excludeValidators: ["disabled"]
        })
    }
    _createSendButtonAction() {
        ...
        this._sendButtonAction = this._createAction(null === sendButtonOptions || void 0 === sendButtonOptions ? void 0 : sendButtonOptions.onClick, {
            excludeValidators: ["disabled"]
        })
    }
    ...
    _optionChanged(args) {
        var _this$_suggestions, _this$_suggestions2, _this$_suggestions3;
        const {
            name: name,
            fullName: fullName,
            value: value
        ...
        switch (name) {
            ...
            case "hoverStateEnabled":
                null === (_this$_suggestions = this._suggestions) || void 0 === _this$_suggestions || _this$_suggestions.updateOptions(this._getSuggestionsConfiguration());
            ...
            case "sendButtonOptions":
                ...
                break;
            case "suggestions":
                null === (_this$_suggestions2 = this._suggestions) || void 0 === _this$_suggestions2 || _this$_suggestions2.updateOptions(this._getSuggestionsConfiguration());
                break;
            case "rtlEnabled":
                null === (_this$_suggestions3 = this._suggestions) || void 0 === _this$_suggestions3 || _this$_suggestions3.updateOptions(this._getSuggestionsConfiguration());
                super._optionChanged(args);
                break;
            default:
                super._optionChanged(args)
    ...
    _dispose() {
        var _this$_suggestions4, _this$_deleteConfirma;
        null === (_this$_suggestions4 = this._suggestions) || void 0 === _this$_suggestions4 || _this$_suggestions4.dispose();
