...
class DataConverter {
    ...
    _convertItemToNode(item, parentKey) {
        ...
        const expanded = this._dataAccessors.getters.expanded(item, {
            defaultValue: false
        });
        const selected = this._dataAccessors.getters.selected(item, {
            defaultValue: false
        });
