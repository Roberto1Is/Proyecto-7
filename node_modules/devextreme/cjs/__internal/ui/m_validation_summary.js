...
class ValidationSummary extends _collection_widget.default {
    ...
    _removeAnnounceContainer() {
        var _this$_$announceConta;
        null === (_this$_$announceConta = this._$announceContainer) || void 0 === _this$_$announceConta || _this$_$announceConta.remove();
        this._$announceContainer = void 0
    }
    _renderAnnounceContainer() {
        this._removeAnnounceContainer();
        this._$announceContainer = (0, _renderer.default)("<div>").addClass("dx-screen-reader-only").attr("role", "alert").appendTo(this.element())
    }
    _announceText(text) {
        var _this$_$announceConta2;
        this._renderAnnounceContainer();
        null === (_this$_$announceConta2 = this._$announceContainer) || void 0 === _this$_$announceConta2 || _this$_$announceConta2.text(text)
    }
