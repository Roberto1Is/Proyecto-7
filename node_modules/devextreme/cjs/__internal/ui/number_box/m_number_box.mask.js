...
class NumberBoxMask extends _m_number_box.default {
    ...
    _supportedKeys() {
        ...
        return Object.assign({}, super._supportedKeys(), {
            ...
            home: this._boundaryKeyHandler.bind(this, 1),
            enter: this._updateFormattedValue.bind(this),
            end: this._boundaryKeyHandler.bind(this, -1)
        })
    }
    _getEffectiveFormatOption() {
        const format = this.option("format");
        return (0, _type.isDefined)(format) ? format : (0, _m_global_format_config.getGlobalFormatByDataType)("number")
    }
    _getTextSeparatorIndex(text) {
        ...
        const patternString = (0, _type.isString)(formatPattern) ? formatPattern : "";
        const realSeparatorOccurrenceIndex = (0, _m_utils.getRealSeparatorIndex)(patternString).occurrence;
    ...
    _arrowHandler(step, e) {
        ...
        if (!(0, _m_number_box2.isCaretInBoundaries)(nextCaret, text, format)) {
            ...
            this._scrollInputTo(1 === step ? "end" : "start")
        }
    }
    _scrollInputTo(edge) {
        ...
        inputElement.scrollLeft = "end" === edge ? inputElement.scrollWidth : 0
    }
    ...
    _boundaryKeyHandler(direction, e) {
        if (!this._useMaskBehavior() || e.shiftKey) {
            return
        }
        this._moveCaretToBoundary(direction);
        e.preventDefault();
        this._scrollInputTo(1 === direction ? "start" : "end")
    }
