...
class FilterBuilder extends Widget {
    ...
    _dimensionChanged() {
        ...
        if (positionOf) {
            ...
            null === (_this$_popupWithTreeV2 = this._popupWithTreeView) || void 0 === _this$_popupWithTreeV2 || _this$_popupWithTreeV2.option("maxHeight", getElementMaxHeightByWindow(positionOf))
        }
    }
