/**
 * DevExtreme (esm/__internal/scheduler/appointment_popup/recurrence_form.js)
 * Version: 26.1.4
...
export class RecurrenceForm {
    ...
    createRecurrenceStartDateGroup() {
        return {
            ...
            }, extend(true, getStartDateCommonConfig(this.config.firstDayOfWeek), {
    ...
    createRecurrenceRule(recurrenceRuleRaw, startDate) {
        ...
        if (0 === recurrenceRule.byDay.length) {
            const defaultByDay = [ICAL_WEEK_DAYS[(null === startDate || void 0 === startDate ? void 0 : startDate.getDay()) ?? this.config.firstDayOfWeek ?? 0]];
