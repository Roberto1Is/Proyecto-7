/**
 * DevExtreme (esm/__internal/scheduler/appointments_new/resizing/get_resizable_config.js)
 * Version: 26.1.4
...
const getReducedHandles = (reduced, rtlEnabled) => {
    switch (reduced) {
        case "head":
...
const getHorizontalRule = options => ({
...
export const getResizableConfig = options => {
    const rule = "vertical" === options.direction ? getVerticalRule(options) : getHorizontalRule(options);
