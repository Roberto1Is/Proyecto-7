/**
 * DevExtreme (esm/__internal/ui/radio_group/radio_group.js)
 * Version: 26.1.4
...
class RadioGroup extends Editor {
    ...
    _itemClickHandler(_ref) {
        ...
        if (null !== (_this$itemElements = this.itemElements()) && void 0 !== _this$itemElements && _this$itemElements.is($(itemElement))) {
            const {
                value: value
            } = this.option();
    ...
    _getSelectedItemKeys(value) {
        ...
        const isNullSelectable = "this" !== valueExpr;
    ...
    _toggleAriaDescribedBy(value) {
        ...
        const targets = null === (_this$itemElements2 = this.itemElements()) || void 0 === _this$itemElements2 ? void 0 : _this$itemElements2.toArray();
        if (!(null !== targets && void 0 !== targets && targets.length)) {
            return
        }
    ...
    _setSubmitValue(value) {
        ...
        const submitValue = "this" === valueExpr ? this._displayGetter(resolvedValue) : resolvedValue;
    ...
    _updateItemsSize() {
        ...
        if ("horizontal" === layout) {
            var _this$itemElements3;
            null === (_this$itemElements3 = this.itemElements()) || void 0 === _this$itemElements3 || _this$itemElements3.css("height", "auto")
        } else {
            var _this$itemElements4;
            const itemsCount = (items ?? []).length;
            null === (_this$itemElements4 = this.itemElements()) || void 0 === _this$itemElements4 || _this$itemElements4.css("height", 100 / itemsCount + "%")
        }
    }
    focus() {
        var _this$_radios;
