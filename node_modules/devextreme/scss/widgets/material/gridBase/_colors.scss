...
$datagrid-border: 1px solid !default;
...
* $type color
*/
$datagrid-selection-bg: color.mix($base-accent, $base-bg, 10%) !default;
...
* $type color
*/
$datagrid-row-focused-bg: color.mix($base-accent, $base-bg, 20%) !default;
...
* $type color
*/
$datagrid-row-invalid-faded-border-color: null !default;
...
$datagrid-master-detail-cell-bg: color.adjust($datagrid-base-background-color, $lightness: -2%, $space: hsl) !default;
...
$datagrid-chevron-icon-color: color.adjust($base-spin-icon-color, $lightness: 38.5%, $space: hsl) !default;
...
$datagrid-columnchooser-message-color: color.adjust($datagrid-base-color, $lightness: 26%, $space: hsl) !default;
...
@if $mode == "light" {
  $datagrid-cell-modified-border-color: color.adjust($base-success, $lightness: 51%, $space: hsl) !default;
  $datagrid-columnchooser-item-color: color.change($datagrid-base-color, $alpha: 0.6) !default;
  $datagrid-block-separator-bg: color.adjust($datagrid-base-background-color, $lightness: -12%, $space: hsl) !default;
  ...
  $datagrid-row-alternation-bg: color.adjust($datagrid-base-background-color, $lightness: -4%, $space: hsl) !default;
  $datagrid-hover-bg: color.adjust($datagrid-base-background-color, $lightness: -4%, $space: hsl) !default;
  ...
  $datagrid-row-invalid-faded-border-color: color.adjust($base-danger, $lightness: 44%, $space: hsl) !default;
}

@if $mode == "dark" {
  $datagrid-cell-modified-border-color: color.adjust($base-success, $lightness: -41%, $space: hsl) !default;
  ...
  $header-filter-color: $datagrid-columnchooser-item-color !default;
  $datagrid-columnchooser-item-bg: color.adjust($datagrid-columnchooser-bg, $lightness: 3%, $space: hsl) !default;
  $datagrid-row-alternation-bg: color.adjust($datagrid-base-background-color, $lightness: 4%, $space: hsl) !default;
  $datagrid-hover-bg: color.adjust($datagrid-base-background-color, $lightness: 4%, $space: hsl) !default;
  $datagrid-text-stub-background-image-path: url("data:image/png;base64,") !default;
  $datagrid-cell-removed-text-color: $datagrid-columnchooser-item-color !default;
  $datagrid-row-invalid-faded-border-color: color.adjust($base-danger, $lightness: -31%, $space: hsl) !default;
}

$header-filter-color-empty: $header-filter-color !default;
