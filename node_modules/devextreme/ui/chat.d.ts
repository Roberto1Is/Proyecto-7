...
export interface dxChatOptions extends WidgetOptions<dxChat> {
    ...
    /**
     * Configures suggestion buttons (DevExtreme ButtonGroup) displayed above the Chat input field.
     */
    ...
    /**
     * A function that is executed after the Chat&apos;s inputFieldText changes.
     */
